...
| 3DO Interactive Multiplayer | {% rauserpic guineu %}                                                                                                              | 5              | <!-- 43  --> |
| Amstrad CPC                 | {% rauserpic roukanumachi %}                                                                                                        | 14             | <!-- 37  --> |
| Apple II                    | {% rauserpic guineu %}                                                                                                              | 12             | <!-- 38  --> |
| Arcade                      | {% rauserpic Wendigo %}                                                                                                             | 51             | <!-- 27  --> |
| Arduboy                     | {% rauserpic Bendyhuman %}                                                                                                          | 17             | <!-- 71  --> |
| Atari 2600                  | {% rauserpic PMniac %}                                                                                                              | 96             | <!-- 25  --> |
| Atari 7800                  | {% rauserpic PMniac %}                                                                                                              | 9              | <!-- 51  --> |
| Atari Jaguar                | {% rauserpic PMniac %}                                                                                                              | 4              | <!-- 17  --> |
| Atari Lynx                  | {% rauserpic guineu %}, {% rauserpic russolini77 %}, {% rauserpic jared6502 %}, {% rauserpic cpbronco %} & {% rauserpic Infernum %} | 3              | <!-- 13  --> |
| ColecoVision                | {% rauserpic PMniac %}                                                                                                              | 8              | <!-- 44  --> |
| Dreamcast                   | {% rauserpic SteveHarvey %}                                                                                                         | 19             | <!-- 40  --> |
| Events                      | {% rauserpic televandalist %}                                                                                                       | 26             | <!-- 101 --> |
| Game Boy                    | {% rauserpic Shootzy %}                                                                                                             | 121            | <!-- 4   --> |
| Game Boy Advance            | {% rauserpic bonecrusher1022 %}                                                                                                     | 106            | <!-- 5   --> |
| Game Boy Color              | {% rauserpic pitapocket17 %}                                                                                                        | 52             | <!-- 6   --> |
| Game Gear                   | {% rauserpic Nydaxn %}                                                                                                              | 59             | <!-- 15  --> |
| Hack Champ                  | {% rauserpic HolyShinx %}                                                                                                           | 189            | <!--     --> |
| Homebrew Champ              | {% rauserpic AuburnRDM %}                                                                                                           | 142            | <!--     --> |
| Intellivision               | {% rauserpic Jungon %}                                                                                                              | 10             | <!-- 45  --> |
| Magnavox Odyssey 2          | {% rauserpic guineu %}, {% rauserpic alphacrust %} & {% rauserpic Jungon %}                                                         | 4              | <!-- 23  --> |
| Master System               | {% rauserpic Jungon %}                                                                                                              | 64             | <!-- 11  --> |
| Mega Drive                  | {% rauserpic DUT %}                                                                                                                 | 117            | <!-- 1   --> |
| MSX                         | {% rauserpic guineu %}                                                                                                              | 7              | <!-- 29  --> |
| Nintendo 64                 | {% rauserpic BenTobitt %}                                                                                                           | 45             | <!-- 2   --> |
| Neo Geo Pocket              | {% rauserpic MelodyAsh %}                                                                                                           | 6              | <!-- 14  --> |
| NES                         | {% rauserpic SanMarino %}                                                                                                           | 236            | <!-- 7   --> |
| Nintendo DS                 | {% rauserpic Olafur %}                                                                                                              | 62             | <!-- 18  --> |
| PC Engine                   | {% rauserpic Infernum %}                                                                                                            | 35             | <!-- 8   --> |
| PC-8000/8800                | {% rauserpic guineu %}                                                                                                              | 9              | <!-- 47  --> |
| PC-FX                       | {% rauserpic Annonith %} & {% rauserpic YahwehTzVaoth %}                                                                            | 3              | <!-- 49  --> |
| PlayStation                 | {% rauserpic Andrey199650 %}                                                                                                        | 75             | <!-- 12  --> |
| PlayStation Portable        | {% rauserpic minibt %}                                                                                                              | 28             | <!-- 41  --> |
| Pokémon Mini                | {% rauserpic Sylrifaide %}                                                                                                          | 32             | <!-- 24  --> |
| Sega 32X                    | {% rauserpic DUT %} & {% rauserpic Nevanos %}                                                                                       | 2              | <!-- 10  --> |
| Sega Saturn                 | {% rauserpic Orph %}                                                                                                                | 15             | <!-- 39  --> |
| Sega CD                     | {% rauserpic Infernum %}                                                                                                            | 5              | <!-- 9   --> |
| SG-1000                     | {% rauserpic PMniac %} & {% rauserpic Jungon %}                                                                                     | 8              | <!-- 33  --> |
| SNES                        | {% rauserpic danibodom %}                                                                                                           | 179            | <!-- 3   --> |
| Vectrex                     | {% rauserpic Jungon %} & {% rauserpic guineu %}                                                                                     | 4              | <!-- 46  --> |
| Virtual Boy                 | {% rauserpic Grahamtams %}                                                                                                          | 11             | <!-- 28  --> |
| WASM-4                      | {% rauserpic AuburnRDM %}                                                                                                           | 25             | <!-- 72  --> |
| Watara Supervision          | {% rauserpic Sarconius %}                                                                                                           | 41             | <!-- 63  --> |
| WonderSwan                  | {% rauserpic Annonith %}                                                                                                            | 3              | <!-- 53  --> |
...
- {% rauserpic alphacrust %} moves into 5th place with 9 new mastery awarcs this month.
- {% rauserpic YahwehTzVaoth %} moves into a tie fir 15th place with 4 new mastery awarcs this month.
