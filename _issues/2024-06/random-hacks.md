...
order: 202406-04
layout: article
title: Random Hacks of Random Series
author: Nepiki
toc: false
toc_float: false
---

Hello all and welcome back to another issue of the RetroAchievements News! Last time, I took a look at paid homebrew titles available on our site, which was very well received. It very conveniently (and unintentionally) lined up with a new DevQuest, so I figured... let's do it again! Although admittedly this one isn't unintentional, and just lines up with the latest [Challenge League](https://retroachievements.org/viewtopic.php?t=24927) board. Of course, when I talk about homebrew titles, I cannot forget to talk about another essential part of RetroAchievements: the ROM hacks!
...
| Game                                                                                                                                 |
| ------------------------------------------------------------------------------------------------------------------------------------ |
| ![](https://retroachievements.org/Images/065335.png) [\~Hack\~ CTGP: Nitro (Nintendo DS)]( https://retroachievements.org/game/17844) |
...
| Game                                                                                                                                                             |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](https://retroachievements.org/Images/057339.png) [\~Hack\~ Final Fantasy VI: Brave New World (SNES/Super Famicom)]( https://retroachievements.org/game/1247) |
...
| Game                                                                                                                                                                 |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](https://retroachievements.org/Images/052201.png) [\~Hack\~ Legend of Zelda, The: Parallel Worlds (SNES/Super Famicom)]( https://retroachievements.org/game/2345) |
...
| Game                                                                                                                                                              |
| ----------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](https://retroachievements.org/Images/089913.png) [\~Hack\~ Castlevania: Aria of Sorrow Reprise (Game Boy Advance)]( https://retroachievements.org/game/22834) |
...
| Game                                                                                                                                                                 |
| -------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![](https://retroachievements.org/Images/017412.png) [\~Hack\~ Rockman no Constancy (NES/Famicom)]( https://retroachievements.org/game/5678)                         |
| ![](https://retroachievements.org/Images/071557.png) [\~Hack\~ Mega Man 2: Rockman no Constancy: Hard Mode (NES/Famicom)]( https://retroachievements.org/game/24096) |
...
Well I say you got a choice but rest assured, the default hack will still test your skill at the mega mans. _Rockman no Constancy_ is also one of the older hacks just like _Parallel Worlds_ we talked about earlier, but yet again it's hardly noticeable. Everything is changed from the base game _Mega Man 2_, with robot masters having different-coloured sprites to match a new element that also changes the mechanics of the weapon you get as a result, and the stages are completely different, both in layout but also definitely in unique graphics and 8-bit music remixed from much later games, like the opening of _Namco x Capcom_ for the PlayStation 2. While it does not introduce any new gimmicks, it is almost completely unrecognizable from the source. What I personally also find impressive (and definitely infuriating), is how random enemies and the bosses themselves have completely different patterns, making them almost completely new boss battles as a result. Later rom hacks would go ever further beyond... especially one that has a specific robot master called "Cheat Man", that definitely absolutely cheats, but it goes to show how impressive rom hacking was already this early on. As shown above, you have the option between either the default hack or hard mode, which highers the defense of enemies and makes you recover less health from pick-ups. Both sets are what you can expect from Mega Man sets, like no deaths during stages as well as doing them buster-only. Solid sets that will always work well for us Mega Man fans!
...
| Game                                                                                                                                             |
| ------------------------------------------------------------------------------------------------------------------------------------------------ |
| ![](https://retroachievements.org/Images/090471.png) [\~Hack\~ Pokemon Prism Version (Game Boy Color)]( https://retroachievements.org/game/9491) |
