...
| 3DO Interactive Multiplayer | {% rauserpic guineu %} & {% rauserpic ChronoGear %}      | 5              | <!-- 43  --> |
| Amstrad CPC                 | {% rauserpic roukanumachi %}                             | 14             | <!-- 37  --> |
| Apple II                    | {% rauserpic guineu %}                                   | 12             | <!-- 38  --> |
| Arcade                      | {% rauserpic Wendigo %}                                  | 56             | <!-- 27  --> |
| Arduboy                     | {% rauserpic Released %}                                 | 20             | <!-- 71  --> |
| Atari 2600                  | {% rauserpic PMniac %}                                   | 96             | <!-- 25  --> |
| Atari 7800                  | {% rauserpic PMniac %}                                   | 10             | <!-- 51  --> |
| Atari Jaguar                | {% rauserpic PMniac %}                                   | 5              | <!-- 17  --> |
| Atari Lynx                  | {% rauserpic guineu %}                                   | 5              | <!-- 13  --> |
| ColecoVision                | {% rauserpic PMniac %}                                   | 8              | <!-- 44  --> |
| Dreamcast                   | {% rauserpic SteveHarvey %}                              | 19             | <!-- 40  --> |
| Events                      | {% rauserpic televandalist %}                            | 26             | <!-- 101 --> |
| Game Boy                    | {% rauserpic Shootzy %}                                  | 123            | <!-- 4   --> |
| Game Boy Advance            | {% rauserpic bonecrusher1022 %}                          | 108            | <!-- 5   --> |
| Game Boy Color              | {% rauserpic pitapocket17 %}                             | 53             | <!-- 6   --> |
| Game Gear                   | {% rauserpic Nydaxn %}                                   | 60             | <!-- 15  --> |
| Hack Champ                  | {% rauserpic HolyShinx %}                                | 190            | <!--     --> |
| Homebrew Champ              | {% rauserpic AuburnRDM %}                                | 153            | <!--     --> |
| Intellivision               | {% rauserpic Jungon %}                                   | 13             | <!-- 45  --> |
| Magnavox Odyssey 2          | {% rauserpic alphacrust %} & {% rauserpic Jungon %}      | 6              | <!-- 23  --> |
| Master System               | {% rauserpic Jungon %}                                   | 68             | <!-- 11  --> |
| Mega Drive                  | {% rauserpic DUT %}                                      | 117            | <!-- 1   --> |
| MSX                         | {% rauserpic guineu %}                                   | 8              | <!-- 29  --> |
| Nintendo 64                 | {% rauserpic BenTobitt %}                                | 45             | <!-- 2   --> |
| Neo Geo Pocket              | {% rauserpic MelodyAsh %}                                | 7              | <!-- 14  --> |
| NES                         | {% rauserpic SanMarino %}                                | 238            | <!-- 7   --> |
| Nintendo DS                 | {% rauserpic Olafur %}                                   | 63             | <!-- 18  --> |
| PC Engine                   | {% rauserpic Infernum %}                                 | 35             | <!-- 8   --> |
| PC-8000/8800                | {% rauserpic guineu %}                                   | 9              | <!-- 47  --> |
| PC-FX                       | {% rauserpic Annonith %} & {% rauserpic YahwehTzVaoth %} | 3              | <!-- 49  --> |
| PlayStation                 | {% rauserpic Andrey199650 %}                             | 76             | <!-- 12  --> |
| PlayStation Portable        | {% rauserpic minibt %}                                   | 32             | <!-- 41  --> |
| Pokémon Mini                | {% rauserpic Sylrifaide %}                               | 32             | <!-- 24  --> |
| Sega 32X                    | {% rauserpic DUT %} & {% rauserpic Fara0 %}              | 3              | <!-- 10  --> |
| Sega Saturn                 | {% rauserpic Orph %}                                     | 15             | <!-- 39  --> |
| Sega CD                     | {% rauserpic Orph %}                                     | 6              | <!-- 9   --> |
| SG-1000                     | {% rauserpic PMniac %} & {% rauserpic Jungon %}          | 8              | <!-- 33  --> |
| SNES                        | {% rauserpic danibodom %}                                | 187            | <!-- 3   --> |
| Vectrex                     | {% rauserpic Jungon %}                                   | 6              | <!-- 46  --> |
| Virtual Boy                 | {% rauserpic Grahamtams %} & {% rauserpic Jungon %}      | 11             | <!-- 28  --> |
| WASM-4                      | {% rauserpic AuburnRDM %}                                | 26             | <!-- 72  --> |
| Watara Supervision          | {% rauserpic Sarconius %}                                | 42             | <!-- 63  --> |
| WonderSwan                  | {% rauserpic Annonith %} & {% rauserpic AuburnRDM %}     | 3              | <!-- 53  --> |
...
- {% rauserpic guineu %} remains in first with 750 total mastery awards.
