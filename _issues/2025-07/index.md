...
<div class="section-link">
    <a href="./raguide.html">
        <div class="section-content">
            ...
            <p>Begin your quest for mastery with our latest RAGuide for Dragon Quest on the NES. Battle monsters, explore a vast kingdom, and gather the strength to defeat the evil Dragonlord and reclaim your rightful place as the hero of Alefgard.</p>
        </div>
    </a>
    ...
    <a href="./radvantage.html">
        <div class="section-content">
            ...
            <p>Stage 6’s boss in SteamGear Mash brings the heat, but taking it down without a scratch is all about staying aggressive while reading its attack patterns. Learn how to take out this tough boss with this months RAdvantage tip.</p>
        </div>
    </a>
</div>
<div class="section-link">
    ...
    <div class="section-content">
        ...
        <table><tbody>
            ...
            <tr>
                ...
                <td>{% rauserpic enemigodelbien %}</td>
            ...
            <tr>
                <td>{% rauserpic WanderingNewbie %}</td>
