...
| Number of sets released.                                         | 141        | <!-- Get from Hot Cheevs -->
| Number of achievements released.                                 | 4,032      | <!-- 01 -->
| Number of hardcore achievements earned.                          | 2,294,785  | <!-- 02 -->
| Number of code notes created.                                    | 15,740     | <!-- 03 -->
| Number of mastery awards awarded.                                | 21,362     | <!-- 04 -->
| Number of beaten awards awarded.                                 | 38,100     | <!-- 04B -->
| Number of set requests made.                                     | 6,584      | <!-- 05 -->
| Number of leaderboards created.                                  | 2,171      | <!-- 06 -->
| Number of leaderboard entries submitted.                         | 467,651    | <!-- 07 -->
| Number of users who have earned at least 1 hardcore achievement. | 41,551     | <!-- 08 -->
| Number of total hardcore points earned by players.               | 14,765,839 | <!-- 09 -->
| Number of total hardcore retro points earned by players.         | 54,244,765 | <!-- 09 -->
| Number of user accounts created.                                 | 38,595     | <!-- 10 -->
| Number of new user accounts reaching ranked status.              | 611        | <!-- 10 -->
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Unlocks</th></tr></thead><tbody>
        ...
        <tr><td>WASM-4                      </td><td>   2,483</td></tr>
...
| Rank | Achievement                                                            | Game                                                                               | Times Awarded |
| :--- | :--------------------------------------------------------------------- | :--------------------------------------------------------------------------------- | :------------ |
| 1    | {% raachpic 490244, 104371, Helping the Innocent %}                    | {% ragamepic 32718, 106174, Achievement of the Week 2025 %}                        | 919           |
| 2    | {% raachpic 523675, 104371, Helping the Innocent %}                    | {% ragamepic 33667, 113017, Achievement of the Week 2025 - E3 %}                   | 897           |
| 3    | {% raachpic 516421, 588531, Obligatory Cartoon Reference %}            | {% ragamepic 10075, 110715, Donkey Kong 64 %}                                      | 863           |
| 4    | {% raachpic 524255, 594138, Run Type: Onion %}                         | {% ragamepic 24371, 074181, Final Fantasy V: Advance [Subset - Four Job Fiesta] %} | 298           |
| 5    | {% raachpic 495239, 580508, Save The Hovercar %}                       | {% ragamepic 32847, 107626, RA Roulette 2025 %}                                    | 283           |
| 6    | {% raachpic 512837, 580494, Willie's Paper Shredder %}                 | {% ragamepic 6343, 110602, The Simpsons: Road Rage %}                              | 274           |
| 7    | {% raachpic 524921, 595080, Mini Mario vs. Yoshi's Island %}           | {% ragamepic 228, 112443, Super Mario World %}                                     | 248           |
| 8    | {% raachpic 525433, 595775, Odyssey Has Started! %}                    | {% ragamepic 33063, 108871, ~Hack~ Pokémon Odyssey %}                              | 237           |
| 9    | {% raachpic 494260, 46760, Bowser Disposer %}                          | {% ragamepic 32838, 110940, RA Roulette 2024 - Evergreen %}                        | 210           |
| 10   | {% raachpic 493747, 129308, Bug Catcher %}                             | {% ragamepic 32836, 110842, RA Roulette 2023 - Evergreen %}                        | 191           |
| 11   | {% raachpic 510100, 578668, Brotherly Rivalry %}                       | {% ragamepic 33398, 110122, ~Hack~ Super Mariomon %}                               | 169           |
| 12   | {% raachpic 515944, 583826, Speed Weed and Dick Wolf Present %}        | {% ragamepic 24, 088907, Altered Beast %}                                          | 164           |
| 13   | {% raachpic 511885, 573459, Bedroom Blitz %}                           | {% ragamepic 3887, 104482, Pokémon Black Version %}                                | 135           |
| 14   | {% raachpic 505419, 572675, 75 Years of F1 RAcing - Driver %}          | {% ragamepic 33092, 109255, 75 Years of F1 RAcing %}                               | 114           |
| 15   | {% raachpic 509639, 577047, City Escape %}                             | {% ragamepic 3779, 066012, Sonic Adventure 2: Battle %}                            | 113           |
| 16   | {% raachpic 510905, 578088, Small Mario Vs Small Bowser %}             | {% ragamepic 11729, 046594, New Super Mario Bros. %}                               | 111           |
| 17   | {% raachpic 502624, 570107, First Step to Victory %}                   | {% ragamepic 30894, 101849, ~Hack~ Pokemon Emerald Seaglass %}                     | 110           |
| 18   | {% raachpic 522818, 594537, C'mon Scoob. Gotta Find Those... Clues. %} | {% ragamepic 21070, 081843, Scooby-Doo! First Frights %}                           | 110           |
| 19   | {% raachpic 514439, 588559, Press 'F' to Pay Respects %}               | {% ragamepic 33480, 110923, Achievement of the Week 2018 - Evergreen %}            | 105           |
| 20   | {% raachpic 523373, 593092, The First Victory %}                       | {% ragamepic 20696, 088835, Devil Kings %}                                         | 103           |
| 21   | {% raachpic 493429, 46583, Special Sorta Person %}                     | {% ragamepic 32833, 106758, Achievement of the Week 2016 - Evergreen %}            | 94            |
| 22   | {% raachpic 527109, 597952, Right Luigi for the Job %}                 | {% ragamepic 33774, 113857, ~Homebrew~ Luigi MasterMind %}                         | 90            |
| 23   | {% raachpic 498556, 564223, Drill That Hedgehog! %}                    | {% ragamepic 6701, 113237, ~Hack~ Robotnik's Revenge %}                            | 89            |
| 24   | {% raachpic 498757, 565464, Now We’re Talkin' %}                       | {% ragamepic 9602, 081455, Super Smash Bros. Melee %}                              | 89            |
| 25   | {% raachpic 523715, 593577, Killing Spree %}                           | {% ragamepic 19047, 113363, Dynasty Warriors 2 %}                                  | 87            |
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Requests</th></tr></thead><tbody>
        ...
        <tr><td>SNES/Super Famicom          </td><td>   260</td></tr>
...
| Number of tickets created.                     | 1,343 | <!-- A -->
| Number of tickets triggered at the wrong time. | 280   | <!-- B -->
| Number of tickets did not trigger.             | 1,063 | <!-- C -->
| Number of tickets resolved.                    | 499   | <!-- D -->
| Number of tickets closed.                      | 639   | <!-- E -->
