...
| Number of sets released.                                         | 80         | <!-- Get from Hot Cheevs -->
| Number of achievements released.                                 | 2,555      | <!-- 01 -->
| Number of hardcore achievements earned.                          | 2,718,973  | <!-- 02 -->
| Number of code notes created.                                    | 18,445     | <!-- 03 -->
| Number of mastery awards awarded.                                | 25,357     | <!-- 04 -->
| Number of beaten awards awarded.                                 | 44,562     | <!-- 04B -->
| Number of set requests made.                                     | 7,655      | <!-- 05 -->
| Number of leaderboards created.                                  | 2,234      | <!-- 06 -->
| Number of leaderboard entries submitted.                         | 559,098    | <!-- 07 -->
| Number of users who have earned at least 1 hardcore achievement. | 46,595     | <!-- 08 -->
| Number of total hardcore points earned by players.               | 17,601,367 | <!-- 09 -->
| Number of total hardcore retro points earned by players.         | 87,289,964 | <!-- 09 -->
| Number of user accounts created.                                 | 41,254     | <!-- 10 -->
| Number of new user accounts reaching ranked status.              | 839        | <!-- 10 -->
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Achievements</th></tr></thead><tbody>
        <tr><td>NES/Famicom                 </td><td>     152</td></tr>
...
| 25   | {% rauserpic FBernkastelKues %} | 29           |
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Unlocks</th></tr></thead><tbody>
        ...
        <tr><td>WASM-4                      </td><td>   3,507</td></tr>
...
| Rank | Achievement                                                  | Game                                                                       | Times Awarded |
| :--- | :----------------------------------------------------------- | :------------------------------------------------------------------------- | :------------ |
| 1    | {% raachpic 537203, 609850, Loyalty Program %}               | {% ragamepic 668, 104473, Pokémon Emerald Version %}                       | 769           |
| 2    | {% raachpic 490253, 539707, Prince of the Earthwalkers %}    | {% ragamepic 32718, 106174, Achievement of the Week 2025 %}                | 660           |
| 3    | {% raachpic 519306, 588938, An Adventure Begins %}           | {% ragamepic 32650, 112095, Kingdom Hearts %}                              | 599           |
| 4    | {% raachpic 539264, 613201, Good Habits Start Early %}       | {% ragamepic 10432, 081158, Crash Bandicoot 2: Cortex Strikes Back %}      | 594           |
| 5    | {% raachpic 495260, 529031, Into the Darkness %}             | {% ragamepic 32847, 107626, RA Roulette 2025 %}                            | 316           |
| 6    | {% raachpic 530936, 608273, Chapter 3 Complete %}            | {% ragamepic 34092, 114852, Retro Adventures: tRAsure Island %}            | 283           |
| 7    | {% raachpic 540248, 614507, Smell Ya Later! %}               | {% ragamepic 586, 117108, Pokémon Blue Version %}                          | 258           |
| 8    | {% raachpic 493747, 129308, Bug Catcher %}                   | {% ragamepic 32836, 110842, RA Roulette 2023 - Evergreen %}                | 232           |
| 9    | {% raachpic 535506, 602745, Phew, Finally! %}                | {% ragamepic 34299, 115264, Retro Adventures: tRAsure Island [Tracking] %} | 225           |
| 10   | {% raachpic 524921, 595080, Mini Mario vs. Yoshi's Island %} | {% ragamepic 228, 112443, Super Mario World %}                             | 216           |
| 11   | {% raachpic 501824, 569145, Elite Hacker %}                  | {% ragamepic 16089, 106988, Medarot 3: Kabuto Version %}                   | 193           |
| 12   | {% raachpic 527746, 613577, This Is Just the Appetizer %}    | {% ragamepic 20859, 065886, OutRun 2006: Coast 2 Coast %}                  | 193           |
| 13   | {% raachpic 494260, 46760, Bowser Disposer %}                | {% ragamepic 32838, 110940, RA Roulette 2024 - Evergreen %}                | 192           |
| 14   | {% raachpic 510100, 578668, Brotherly Rivalry %}             | {% ragamepic 33398, 110122, ~Hack~ Super Mariomon %}                       | 192           |
| 15   | {% raachpic 516421, 588531, Obligatory Cartoon Reference %}  | {% ragamepic 10075, 110715, Donkey Kong 64 %}                              | 179           |
| 16   | {% raachpic 511885, 573459, Bedroom Blitz %}                 | {% ragamepic 3887, 104482, Pokémon Black Version %}                        | 161           |
| 17   | {% raachpic 513543, 581098, The Looting Begins %}            | {% ragamepic 13341, 110812, Montezuma's Revenge %}                         | 161           |
| 18   | {% raachpic 517392, 610886, Showdown at the Rocky Gym %}     | {% ragamepic 32009, 111520, ~Hack~ Pokemon PureRGB %}                      | 152           |
| 19   | {% raachpic 531162, 602100, Give Back the Food %}            | {% ragamepic 34125, 114951, Satoru Iwata Memorial Event %}                 | 151           |
| 20   | {% raachpic 534443, 611194, Welcome to the Shadows %}        | {% ragamepic 2998, 065400, Tom Clancy's Splinter Cell %}                   | 148           |
| 21   | {% raachpic 534537, 607467, Dog Collector %}                 | {% ragamepic 26731, 115844, ~Hack~ Tails in Sonic the Hedgehog %}          | 136           |
| 22   | {% raachpic 502624, 570107, First Step to Victory %}         | {% ragamepic 30894, 101849, ~Hack~ Pokemon Emerald Seaglass %}             | 134           |
| 23   | {% raachpic 514448, 315516, One Tile Away from Beauty %}     | {% ragamepic 33480, 110923, Achievement of the Week 2018 - Evergreen %}    | 134           |
| 24   | {% raachpic 537343, 610563, Partial Completion from SMA2 %}  | {% ragamepic 33610, 111845, ~Hack~ Yet Another Vanilla SMA2 Hack %}        | 134           |
| 25   | {% raachpic 525433, 595775, Odyssey Has Started! %}          | {% ragamepic 33063, 108871, ~Hack~ Pokémon Odyssey %}                      | 133           |
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Notes</th></tr></thead><tbody>
        ...
        <tr><td>Amstrad CPC                 </td><td>      34</td></tr>
        <tr><td>Arcade                      </td><td>     382</td></tr>
        <tr><td>Arduboy                     </td><td>      62</td></tr>
        <tr><td>Atari 2600                  </td><td>     139</td></tr>
        <tr><td>Dreamcast                   </td><td>     214</td></tr>
        <tr><td>Fairchild Channel F         </td><td>       9</td></tr>
        <tr><td>Game Boy                    </td><td>     299</td></tr>
        <tr><td>Game Boy Advance            </td><td>   1,976</td></tr>
        <tr><td>Game Boy Color              </td><td>     317</td></tr>
...
| Number of tickets created.                     | 1,731 | <!-- A -->
| Number of tickets triggered at the wrong time. | 363   | <!-- B -->
| Number of tickets did not trigger.             | 1,368 | <!-- C -->
| Number of tickets resolved.                    | 623   | <!-- D -->
| Number of tickets closed.                      | 898   | <!-- E -->
