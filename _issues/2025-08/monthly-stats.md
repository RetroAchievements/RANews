...
| Number of sets released.                                         | 96         | <!-- Get from Hot Cheevs -->
| Number of achievements released.                                 | 2,766      | <!-- 01 -->
| Number of hardcore achievements earned.                          | 2,477,500  | <!-- 02 -->
| Number of code notes created.                                    | 17,459     | <!-- 03 -->
| Number of mastery awards awarded.                                | 23,255     | <!-- 04 -->
| Number of beaten awards awarded.                                 | 42,178     | <!-- 04B -->
| Number of set requests made.                                     | 7,230      | <!-- 05 -->
| Number of leaderboards created.                                  | 1,432      | <!-- 06 -->
| Number of leaderboard entries submitted.                         | 516,822    | <!-- 07 -->
| Number of users who have earned at least 1 hardcore achievement. | 43,951     | <!-- 08 -->
| Number of total hardcore points earned by players.               | 15,941,768 | <!-- 09 -->
| Number of total hardcore retro points earned by players.         | 60,362,634 | <!-- 09 -->
| Number of user accounts created.                                 | 40,968     | <!-- 10 -->
| Number of new user accounts reaching ranked status.              | 696        | <!-- 10 -->
...
| 9    | {% rauserpic TwosomesUP %}      | 100          |
| 10   | {% rauserpic multonic %}        | 99           |
| 11   | {% rauserpic Vancleef %}        | 82           |
| 12   | {% rauserpic SuperMeatBro %}    | 76           |
...
| 16   | {% rauserpic AlexGatao %}           |     29,520      |    205,110     |      1,615,404       |
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Unlocks</th></tr></thead><tbody>
        ...
        <tr><td>WASM-4                      </td><td>   2,917</td></tr>
...
| 2    | {% rauserpic MillenniumEye %}  |    2,163     | 12,865 |    25,253    |       84       |
...
| 13   | {% rauserpic MarioKness %}     |    1,433     | 6,410  |    24,239    |       47       |
| 14   | {% rauserpic LinCrash %}       |    1,411     | 12,289 |    19,780    |       26       |
| 15   | {% rauserpic Pit100 %}         |    1,406     | 8,600  |    18,772    |       55       |
...
| 19   | {% rauserpic hugohikari %}     |    1,348     | 8,659  |    15,177    |       31       |
| 20   | {% rauserpic Knifemaker1 %}    |    1,337     | 7,748  |    23,752    |       29       |
...
| Rank | Achievement                                                                            | Game                                                                               | Times Awarded |
| :--- | :------------------------------------------------------------------------------------- | :--------------------------------------------------------------------------------- | :------------ |
| 1    | {% raachpic 490248, 166436, Royal Family Song %}                                       | {% ragamepic 32718, 106174, Achievement of the Week 2025 %}                        | 727           |
| 2    | {% raachpic 502508, 569915, Quest for Masters %}                                       | {% ragamepic 11202, 048069, The Legend of Zelda: Ocarina of Time - Master Quest %} | 709           |
| 3    | {% raachpic 523678, 427849, Repairboy %}                                               | {% ragamepic 33667, 113017, Achievement of the Week 2025 - E3 %}                   | 556           |
| 4    | {% raachpic 530934, 604250, Chapter 1 Complete %}                                      | {% ragamepic 34092, 114852, Retro Adventures: tRAsure Island %}                    | 326           |
| 5    | {% raachpic 495249, 571375, Chuffing and Puffing %}                                    | {% ragamepic 32847, 107626, RA Roulette 2025 %}                                    | 301           |
| 6    | {% raachpic 531162, 602100, Give Back the Food %}                                      | {% ragamepic 34125, 114951, Satoru Iwata Memorial Event %}                         | 291           |
| 7    | {% raachpic 503930, 571375, Chuffing and Puffing %}                                    | {% ragamepic 20052, 109095, Kikansha Thomas: DS de Hajimeru Chiiku Gakushuu %}     | 257           |
| 8    | {% raachpic 524921, 595080, Mini Mario vs. Yoshi's Island %}                           | {% ragamepic 228, 112443, Super Mario World %}                                     | 234           |
| 9    | {% raachpic 516421, 588531, Obligatory Cartoon Reference %}                            | {% ragamepic 10075, 110715, Donkey Kong 64 %}                                      | 229           |
| 10   | {% raachpic 494260, 46760, Bowser Disposer %}                                          | {% ragamepic 32838, 110940, RA Roulette 2024 - Evergreen %}                        | 218           |
| 11   | {% raachpic 510916, 578099, Not That Tall %}                                           | {% ragamepic 11729, 046594, New Super Mario Bros. %}                               | 197           |
| 12   | {% raachpic 493747, 129308, Bug Catcher %}                                             | {% ragamepic 32836, 110842, RA Roulette 2023 - Evergreen %}                        | 196           |
| 13   | {% raachpic 510100, 578668, Brotherly Rivalry %}                                       | {% ragamepic 33398, 110122, ~Hack~ Super Mariomon %}                               | 189           |
| 14   | {% raachpic 532499, 359831, The Rainforest %}                                          | {% ragamepic 34299, 115264, Retro Adventures: tRAsure Island [Tracking] %}         | 174           |
| 15   | {% raachpic 529986, 601073, Welcome to Hell %}                                         | {% ragamepic 15964, 108105, ~Hack~ Smash Remix %}                                  | 172           |
| 16   | {% raachpic 520652, 600787, WARNING: Please Enable Leaderboards for Full Experience %} | {% ragamepic 26471, 114502, ~Homebrew~ Among Us %}                                 | 169           |
| 17   | {% raachpic 506402, 573711, Flower Power %}                                            | {% ragamepic 29578, 109251, Trip World DX %}                                       | 166           |
| 18   | {% raachpic 530072, 601240, Number Go Up %}                                            | {% ragamepic 28355, 114475, Stonk Simulator %}                                     | 166           |
| 19   | {% raachpic 533383, 605294, Yep, That's All of 'Em %}                                  | {% ragamepic 34305, 115448, ~Hack~ Mario Breaks EVERY BONE IN HIS BODY %}          | 143           |
| 20   | {% raachpic 511885, 573459, Bedroom Blitz %}                                           | {% ragamepic 3887, 104482, Pokémon Black Version %}                                | 136           |
| 21   | {% raachpic 504289, 593541, Hellbound Express %}                                       | {% ragamepic 19111, 110883, Darkwatch %}                                           | 128           |
| 22   | {% raachpic 509639, 577047, City Escape %}                                             | {% ragamepic 3779, 115618, Sonic Adventure 2: Battle %}                            | 126           |
| 23   | {% raachpic 502624, 570107, First Step to Victory %}                                   | {% ragamepic 30894, 101849, ~Hack~ Pokemon Emerald Seaglass %}                     | 124           |
| 24   | {% raachpic 531309, 603052, Red Light, Green Light %}                                  | {% ragamepic 34028, 114454, ~Homebrew~ Squid Game Boy %}                           | 120           |
| 25   | {% raachpic 514446, 123700, What Is This, Some Kind of Learning Game?! %}              | {% ragamepic 33480, 110923, Achievement of the Week 2018 - Evergreen %}            | 116           |
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Notes</th></tr></thead><tbody>
        ...
        <tr><td>Amstrad CPC                </td><td>   126</td></tr>
        <tr><td>Apple II                   </td><td>     4</td></tr>
        <tr><td>Arcade                     </td><td>   281</td></tr>
        <tr><td>Arduboy                    </td><td>    10</td></tr>
        <tr><td>Atari 2600                 </td><td>    21</td></tr>
...
<div>
    ...
    <table><thead><tr><th>Rank</th><th>Developer</th><th>Leaderboards</th></tr></thead><tbody>
        <tr><td>1</td><td>{% rauserpic Farbefab %}        </td><td>150</td></tr>
        <tr><td>2</td><td>{% rauserpic NamcoPlayer9871 %} </td><td>127</td></tr>
        <tr><td>3</td><td>{% rauserpic LordAndrew %}      </td><td>104</td></tr>
        <tr><td>4</td><td>{% rauserpic DarkyAndreas %}    </td><td>62</td></tr>
        <tr><td>5</td><td>{% rauserpic calendario %}      </td><td>56</td></tr>
    </tbody></table>
    </div> <div style='width:49%;display:inline-block;float:right'>
    <table><thead><tr><th>Rank</th><th>Developer</th><th>Leaderboards</th></tr></thead><tbody>
...
| Number of tickets created.                     | 1,468 | <!-- A -->
| Number of tickets triggered at the wrong time. | 314   | <!-- B -->
| Number of tickets did not trigger.             | 1,154 | <!-- C -->
| Number of tickets resolved.                    | 548   | <!-- D -->
| Number of tickets closed.                      | 708   | <!-- E -->
