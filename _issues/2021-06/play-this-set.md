...
The set is comprehensive, with a good variety of goals and challenges. BahamutVoid has worked to highlight unique features of the hack where possible, like using character's abilities to find previously inaccessible areas or evade hazards. This really helps celebrate the efforts of the hack's developer, and encourage players to discover all the hidden and easily overlooked parts of the game. Some parts of the set reward pure skill and test even experienced players, but there's plenty of chances for newbies like me to snag points too. (Some might take a *few* more tries, but I'm getting there!) No Sonic set would be complete without a speedrun, but the ones here are more about finding optimal routes and shortcuts rather than pixel-perfect play.   

Want to see just how fast you *can* go though? There's 118 speedrun leaderboards available. As well, each character has entries for high score and completing the game with as few deaths, jumps, spindashes or hits taken as possible. Finally, if any truly die-hard Sonic fans are worried this might not be enough to sate their appetites, did I mention there's an Achievement for *every single Stage* in the hack? *And* a Bonus Set.   
