...
| Amstrad CPC                 | {% rauserpic roukanumachi %}                                                                              | 12             | <!-- 37 -->  |
| Apple II                    | {% rauserpic guineu %}                                                                                    | 12             | <!-- 38 -->  |
| Arcade                      | {% rauserpic DUT %}                                                                                       | 50             | <!-- 27 -->  |
| Atari 2600                  | {% rauserpic PMniac %}                                                                                    | 94             | <!-- 25 -->  |
| Atari 7800                  | {% rauserpic PMniac %}                                                                                    | 8              | <!-- 51 -->  |
| Atari Jaguar                | {% rauserpic PMniac %}                                                                                    | 4              | <!-- 17 -->  |
| Atari Lynx                  | {% rauserpic guineu %}, {% rauserpic russolini77 %}, {% rauserpic jared6502 %} & {% rauserpic cpbronco %} | 3              | <!-- 13 -->  |
| ColecoVision                | {% rauserpic PMniac %}                                                                                    | 8              | <!-- 44 -->  |
| Dreamcast                   | {% rauserpic SteveHarvey %}                                                                               | 19             | <!-- 40 -->  |
| Events                      | {% rauserpic televandalist %}                                                                             | 26             | <!-- 101 --> |
| Game Boy                    | {% rauserpic Shootzy %}                                                                                   | 120            | <!-- 4 -->   |
| Game Boy Advance            | {% rauserpic bonecrusher1022 %}                                                                           | 106            | <!-- 5 -->   |
| Game Boy Color              | {% rauserpic pitapocket17 %}                                                                              | 50             | <!-- 6 -->   |
| Game Gear                   | {% rauserpic Nydaxn %}                                                                                    | 58             | <!-- 15 -->  |
| Hack Champ                  | {% rauserpic HolyShinx %}                                                                                 | 188            | <!--  -->    |
| Homebrew Champ              | {% rauserpic AuburnRDM %}                                                                                 | 126            | <!--  -->    |
| Intellivision               | {% rauserpic Jungon %}                                                                                    | 10             | <!-- 45 -->  |
| Magnavox Odyssey 2          | {% rauserpic guineu %} & {% rauserpic alphacrust %}                                                       | 4              | <!-- 23 -->  |
| Master System               | {% rauserpic Jungon %}                                                                                    | 60             | <!-- 11 -->  |
| Mega Drive                  | {% rauserpic DUT %}                                                                                       | 116            | <!-- 1 -->   |
| MSX                         | {% rauserpic guineu %}                                                                                    | 7              | <!-- 29 -->  |
| Nintendo 64                 | {% rauserpic BenTobitt %}                                                                                 | 43             | <!-- 2 -->   |
| Neo Geo Pocket              | {% rauserpic Nanashi %}                                                                                   | 4              | <!-- 14 -->  |
| NES                         | {% rauserpic SanMarino %}                                                                                 | 233            | <!-- 7 -->   |
| Nintendo DS                 | {% rauserpic Olafur %}                                                                                    | 61             | <!-- 18 -->  |
...
| PlayStation Portable        | {% rauserpic minibt %}                                                                                    | 23             | <!-- 41 -->  |
| Pokémon Mini                | {% rauserpic AuburnRDM %}                                                                                 | 19             | <!-- 24 -->  |
| Sega 32X                    | {% rauserpic DUT %} & {% rauserpic Nevanos %}                                                             | 2              | <!-- 10 -->  |
| Sega Saturn                 | {% rauserpic Boldewin %}                                                                                  | 13             | <!-- 39 -->  |
| Sega CD                     | {% rauserpic Infernum %}                                                                                  | 5              | <!-- 9 -->   |
| SG-1000                     | {% rauserpic PMniac %} & {% rauserpic Jungon %}                                                           | 7              | <!-- 33 -->  |
| SNES                        | {% rauserpic danibodom %}                                                                                 | 173            | <!-- 3 -->   |
| Vectrex                     | {% rauserpic Jungon %}                                                                                    | 3              | <!-- 46 -->  |
| Virtual Boy                 | {% rauserpic Grahamtams %}                                                                                | 5              | <!-- 28 -->  |
