...
<div class="section-link">
    <a href="./raguide.html">
        <div class="section-content">
            ...
            <p>Experience the Pacific theater like never before with our latest RAGuide for Medal of Honor: Rising Sun. Step into the boots of Marine Joe Griffin as you fight across historic World War II battles, from Pearl Harbor to the jungles of the Philippines. This robust guide will help you master each mission, complete bonus objectives, and earn service medals ans you make your way through the set.</p>
        </div>
    </a>
    ...
    <a href="./radvantage.html">
        <div class="section-content">
            ...
            <p>Sink 100 ships in Sea Trader: Rise of Taipan and prove you’re the most feared captain to ever set sail with the latest RAdvantage tip. This can be a grindy task, but we've got the best setup to get you on the right track to unlocking this achievement.</p>
        </div>
    </a>
</div>
<div class="section-link">
    ...
    <div class="section-content">
        ...
        <table><tbody>
            ...
            <tr>
                ...
                <td>{% rauserpicalt jordanreal420, playcustomdelivery %}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>{% rauserpic LeftyGuitar %}</td>
                <td>{% rauserpic Lokomelo %}</td>
                <td>{% rauserpic ManyHours %}</td>
            </tr>
            <tr>
                <td>{% rauserpic MirbyStudios %}</td>
