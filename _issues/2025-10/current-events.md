...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>5 users are currently tied in first place with 55 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>27 users are currently tied in first place with 79 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>

## Halloween 2025 - Escape the Forest of Demotion

<table>
    <tbody>
        <tr>
            <td><strong>Event Page:</strong></td>
            <td>{% raeventpic 187, 118837, Halloween 2025 - Forest of Demotion %}</td>
        </tr>
        <tr>
            <td><strong>Event Summary:</strong></td>
            <td>Features 12 popular video game villains over 24 weeks, with participants completing tasks of varying lengths every 2 weeks to earn points towards badges.</td>
        ...
        <tr>
            <td><strong>Event Information:</strong></td>
            <td><a href="https://retroachievements.org/viewtopic.php?t=32614">https://retroachievements.org/viewtopic.php?t=32614</a></td>
        </tr>
        <tr>
            <td><strong>Duration:</strong></td>
            <td>Active from 10/01/25 - 11/30/25</td>
        </tr>
        <tr>
            <td><strong>Host(s):</strong></td>
            <td>{% rauserpic RAEvents %}</td>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>112 users have earned the Halloween 2025 - Escape the Forest of Demotion badge.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic WanderingHeiho %} - 134 Points</li>
                    <li value="2">{% rauserpic Sutarion %} - 126 Points</li>
                    <li value="3">{% rauserpic Tyrota %} - 122 Points</li>
                    <li value="3">{% rauserpicalt ThatWhiteBat, Sylrifaide %} - 122 Points</li>
                    <li value="3">{% rauserpic Greyfalken %} - 122 Points</li>
                    <li value="6">{% rauserpic TanteiRotana %} - 121 Points</li>
                    <li value="7">{% rauserpic WeerDough %} - 120 Points</li>
                    <li value="7">{% rauserpic Pikapals %} - 120 Points</li>
                    <li value="7">{% rauserpic Akai %} - 120 Points</li>
                    <li value="7">{% rauserpic HungryWalnut %} - 120 Points</li>
                </ol>
        ...
        <tr>
            ...
            <td>
                <ol>
                    ...
                    <li value="3">{% rauserpic GenesisRA, genesislover %} - 46 Points</li>
                    <li value="4">{% rauserpic Kaiserlucas %} - 44 Points</li>
                    <li value="5">{% rauserpic MeloDeathAtmoBlack %} - 42 Points</li>
                    <li value="6">{% rauserpic s0uth %} - 34 Points</li>
                    <li value="6">{% rauserpic PepeJohn %} - 34 Points</li>
                    <li value="8">{% rauserpicalt Kexin, Nintagious %} - 33 Points</li>
                    <li value="9">{% rauserpic jhonen124 %} - 30 Points</li>
                    <li value="9">{% rauserpic SushiSeijin %} - 30 Points</li>
                    <li value="9">{% rauserpic Daroachie %} - 30 Points</li>
                </ol>
            </td>
        </tr>
    </tbody>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Notable Details:</strong></td>
            <td>Board 7: October 1 - November 15</td>
        </tr>
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>
                <ol>
                    <li value="1">{% rauserpic DeeCee %} - 212 SPs, 7 Stamps</li>
                    <li value="1">{% rauserpic Reeve42 %} - 212 SPs, 7 Stamps</li>
                    <li value="3">{% rauserpic shindanix %} - 210 SPs, 7 Stamps</li>
                    <li value="4">{% rauserpic Sutarion %} - 202 SPs, 7 Stamps</li>
                    <li value="5">{% rauserpic Adenothe %} - 192 SPs, 7 Stamps</li>
                    <li value="6">{% rauserpic chris316 %} - 191 SPs, 7 Stamps</li>
                    <li value="7">{% rauserpic BubbleRoxie %} - 185 SPs, 6 Stamps</li>
                    <li value="8">{% rauserpicalt TrashPaddy, PaddyShade %} - 176 SPs, 7 Stamps</li>
                    <li value="9">{% rauserpic Pikapals %} - 175 SPs, 6 Stamps</li>
                    <li value="10">{% rauserpic ArtikSkarab %} - 154 SPs, 7 Stamps</li>
                </ol>
            </td>
        </tr>
    </tbody>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colspan=2>{% ragamepic 23849, 083037, Rally Chase | Thrash Rally %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic Trisscorp %}</td>
                            <td colspan=2>{% ragamepic 1912, 012931, RoadBlasters %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic Wubdor %}</td>
                            <td colspan=2>{% ragamepic 14507, 068564, The House of the Dead %}</td>
                        </tr>
                        <tr>
                            <td rowspan=3>{% rauserpic Xymjak %}</td>
                            <td colspan=2>{% ragamepic 16503, 083573, Rally Chase | Thrash Rally %}</td>
                        </tr>
                    </tbody>
                </table>
                <br>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic NEOMAR %}<sup>**</sup> - 1389 Points</li>
                    <li value="2">{% rauserpic Lonoke31 %}<sup>**</sup> - 1306 Points</li>
                    <li value="3">{% rauserpic Sutarion %}<sup>**</sup> - 1097 Points</li>
                    <li value="4">{% rauserpic Timmay %}<sup>**</sup> - 1087 Points</li>
                    <li value="5">{% rauserpicalt AmirGaris, Amir96lx %}<sup>**</sup> - 1028 Points</li>
                    <li value="6">{% rauserpic MiningMario %}<sup>**</sup> - 995 Points</li>
                    <li value="7">{% rauserpic NeoRetroGamer %}<sup>**</sup> - 665 Points</li>
