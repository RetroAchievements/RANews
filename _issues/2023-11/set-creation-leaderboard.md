...
| ---- | ----------------------------- | ------------ |
| 1    | {% rauserpic Snow %}          | 28           |
| 2    | {% rauserpic zxmega %}        | 26           |
| 3    | {% rauserpic Excessiveiser %} | 18           |
| 3    | {% rauserpic timenoe %}       | 18           |
| 5    | {% rauserpic TeddyWestside %} | 17           |
| 6    | {% rauserpic blendedsea %}    | 14           |
| 7    | {% rauserpic Delmaru %}       | 13           |
| 7    | {% rauserpic Gollawiz %}      | 13           |
| 9    | {% rauserpic Bryan1150 %}     | 12           |
...
| 8    | {% rauserpic AlexGatao %}           | 2            |
| 8    | {% rauserpic BrunoKiko %}           | 2            |
| 8    | {% rauserpic Excessiveiser %}       | 2            |
| 8    | {% rauserpic guindev %}             | 2            |
| 8    | {% rauserpic monkeytoung %}         | 2            |
| 8    | {% rauserpic rabbids4eva %}         | 2            |
| 8    | {% rauserpic TeddyWestside %}       | 2            |
| 8    | {% rauserpic voiceofautumn %}       | 2            |
