...
# Community Updates
* [Softcore Points](https://retroachievements.org/viewtopic.php?t=13893) Update
* Massive amount of site updates, most notably RAWeb Version 2.0. The framework changes included in this update have paved the way towards some long awaited and request site updates. Full list of updates is [here](./year-in-review-updates.html#raweb).
* Tons of emulator and dev tool updates allow devs to make achievement more efficiently. Full list of updates is [here](./year-in-review-updates.html#development-tool-updates).
* QATeam split into dedicated `Quality Assurance`, `Developer Compliance` and `DevQuest` teams.
* {% rauser RAEvents %} team created to handle the current and upcoming RA events.
* [Quality Quest](https://retroachievements.org/viewtopic.php?t=16066&c=115234) created to help the website as a whole, whether it be rescores, grammar corrections, ticket save states or full game save states.
* [What are RetroAchievements?](https://www.youtube.com/watch?v=g0hmYv6czs8) video by iShade.
* [The Anatomy Of A Good Ticket](https://docs.google.com/document/d/1cDnXwvuxa0l6wmvcKSQrTZA3crvG4w2YPgbCIHugeTI/edit) article by VoiceOfAutumn.
* Retro Olympics 2022 ongoing. More information [here](https://starblades.github.io/retro-olympics/).
* RAPodcast started. Current episodes can be viewed at the official [YouTube Channel](https://www.youtube.com/@RAPodcast).
...
* [Subset Rule](https://docs.retroachievements.org/Subsets/) Updates
...
* [Developer Inactivity](https://docs.retroachievements.org/Developers-Code-of-Conduct/#expiration-of-developer-status) Updates
...
* [Set Plagiarism](https://docs.retroachievements.org/Set-Plagiarism/) Rule Introduced
...
| {% rauserpic AuburnRDM %}  | {% rauserpic BahamutVoid %}  | {% rauserpic Hotscrock %} |
| {% rauserpic KickMeElmo %} | {% rauserpic pinguupinguu %} | {% rauserpic Snow %}      |
| {% rauserpic SporyTike %}  | {% rauserpic Suffa28 %}      |                           |
...
| {% rauserpic Brandovsky %}   | {% rauserpic Bryan1150 %}           | {% rauserpic DanielARP %}      |
| {% rauserpic DoctorV %}      | {% rauserpic Falcus %}              | {% rauserpic Fridge %}         |
| {% rauserpic gollawiz %}     | {% rauserpic malasdair %}           | {% rauserpic MrOwnership %}    |
| {% rauserpic pinguupinguu %} | {% rauserpic Ryudo %}               | {% rauserpic Searo %}          |
| {% rauserpic Shmelyoff %}    | {% rauserpic SlashTangent %}        | {% rauserpic SporyTike %}      |
| {% rauserpic Suffa28 %}      | {% rauserpic ThatAmericanSlacker %} | {% rauserpic TheMysticalOne %} |
| {% rauserpic timenoe %}      | {% rauserpic xnaivx %}              |                                |
...
| {% rauserpic Bartis1989 %}    | {% rauserpic DanielARP %} | {% rauserpic DoctorV %}       |
| {% rauserpic Hotscrock %}     | {% rauserpic Infernox %}  | {% rauserpic MrOwnership %}   |
| {% rauserpic psyduck %}       | {% rauserpic Searo %}     | {% rauserpic Soulsderfuchs %} |
| {% rauserpic televandalist %} |                           |                               |

Please reach out to {% rauserpic QATeam %} for any questions, comments or concerns.
...
| {% rauserpic BigWeedSmokerMan %} | {% rauserpic Bryan1150 %}     | {% rauserpic DoctorV %}       |
| {% rauserpic Etron %}            | {% rauserpic GalacticSpear %} | {% rauserpic Hotscrock %}     |
| {% rauserpic Infernox %}         | {% rauserpic Malasdair %}     | {% rauserpic MrOwnership %}   |
| {% rauserpic pinguupinguu %}     | {% rauserpic psyduck %}       | {% rauserpic televandalist %} |
| {% rauserpic TheMysticalOne %}   | {% rauserpic timenoe %}       |                               |

Please reach out to {% rauserpic DevCompliance %} for and questions, comments, or concerns.
...
| {% rauserpic bcrew1375 %}           | {% rauserpic BigWeedSmokerMan %} | {% rauserpic Daroachie %}   |
| {% rauserpic evolutespirit %}       | {% rauserpic FBernkastelKues %}  | {% rauserpic GameZone %}    |
| {% rauserpic Haruda %}              | {% rauserpic HolyShinx %}        | {% rauserpic Jason12345 %}  |
| {% rauserpic Kinglink %}            | {% rauserpic LimeJinjo %}        | {% rauserpic ockerjj %}     |
| {% rauserpic Pudpod %}              | {% rauserpic RandoT %}           | {% rauserpic Retrokaiser %} |
| {% rauserpic Soulsderfuchs %}       | {% rauserpic starblades %}       | {% rauserpic TheoVellum %}  |
| {% rauserpic TheRecognitionScene %} | {% rauserpic Timrtabor123 %}     | {% rauserpic zizom %}       |
| {% rauserpic Zpeligo %}             |                                  |                             |
...
| {% rauserpic HolyShinx %}       | {% rauserpic Hotscrock %}  | {% rauserpic MrOwnership %}  |
| {% rauserpic Nepiki %}          | {% rauserpic Nydaxn %}     | {% rauserpic pinguupinguu %} |
| {% rauserpic Raykusen %}        | {% rauserpic SporyTike %}  | {% rauserpic StingX2 %}      |
| {% rauserpic TimeCrush %}       | {% rauserpic Xymjak %}     |                              |

If you are interested in joining the RANews Team, plese reach out to {% rauserpic RANews %} or any of the members above.

# Events Team
The new Site and Discord Events team was created to maintain the vast amount of events that are RA has ongoing and coming up. Their responsibilities include approving new events, helping to run and organize events, and hosting events that do not have a dedicated host. The team can be reached from Site by contacts {% rauser RAEvents %} or via Discord by contacting `@Events-Team`. The current members of the Events Team are:

| {% rauserpic AuburnRDM %}      | {% rauserpic Bendyhuman %}    | {% rauserpic FBernkastelKues %} |
| {% rauserpic freezestar %}     | {% rauserpic genesislover %}  | {% rauserpic JAM %}             |
| {% rauserpic Jenettebaghead %} | {% rauserpic LootusMaximus %} | {% rauserpic pinguupinguu %}    |
| {% rauserpic Pudpod %}         | {% rauserpic Ryudo %}         | {% rauserpic Snow %}            |
| {% rauserpic starblades %}     | {% rauserpic StingX2 %}       | {% rauserpic televandalist %}   |
| {% rauserpic xClawz %}         |                               |                                 |

# Events
RetroAchievements offers a wide range of unique and entertaining events throughout the year to get the community members involved in some friendly competition. The [Current Events](./current-events.html) section of RANews keeps everyone up to date with the latest and greatest event news of the past year.

# DevQuest
What is {% rauserpic DevQuest %}? It's simple: They're achievement development-related QUESTS that act like an MMO. These quests do not have a time limit, and by completing each one you earn a site badge. You can start a quest today, one week later, or even three months later: they will still be there for you!
...
| {% rauserpic Brandovsky %}    | {% rauserpic Cadaxar %}        | {% rauserpic DoctorV %}        |
| {% rauserpic GalacticSpear %} | {% rauserpic LogicalFallacy %} | {% rauserpic pinguupinguu %}   |
| {% rauserpic siouxerskate %}  | {% rauserpic SlashTangent %}   | {% rauserpic Snow %}           |
| {% rauserpic StingX2 %}       | {% rauserpic televandalist %}  | {% rauserpic themysticalone %} |
| {% rauserpic timenoe %}       | {% rauserpic wolfman2000 %}    |                                |
...
| `#dev-compliance-inbox` | Messages to the {% rauser DevCompliance %} site user gets forwarded here.                                            |
...
| `#devquest-inbox`       | Messages to the {% rauser DevQuest %} site user gets forwarded here.                                                 |
...
| `#qualityquest-inbox`   | Messages to the {% rauser QualityQuest %} site user gets forwarded here.                                             |
...
# RAGuide
The [RAGuide Wiki](https://github.com/RetroAchievements/guides/wiki) allows users to create and share set guides with the rest of community. If you are interested in created guide head on over to the [RAGuide Wiki](https://github.com/RetroAchievements/guides/wiki) and create a new page to start working on one. In the meantime, check out the guides that were featured this past year.

| Game                                                                                                                                                                                                                                                                                                                              | Guide By                  | Guide Link                                                                                                         |
| :-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :------------------------ | :----------------------------------------------------------------------------------------------------------------- |
| <a class="gameicon-link" href="https://retroachievements.org/game/355" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/032817.png" alt="Legend of Zelda, The: A Link to the Past (SNES)"> <span>Legend of Zelda, The: A Link to the Past (SNES)</span></a>                        | {% rauserpic Nepiki %}    | [Guide](https://github.com/RetroAchievements/guides/wiki/The-Legend-of-Zelda,-A-Link-to-the-Past-(SNES))           |
| <a class="gameicon-link" href="https://retroachievements.org/game/1913" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/008563.png" alt="Robin Hood: Prince of Thieves (NES)"> <span>Robin Hood: Prince of Thieves (NES)</span></a>                                               | {% rauserpic ikki5 %}     | [Guide](https://github.com/RetroAchievements/guides/wiki/Robin-Hood-Prince-of-Thieves-(NES))                       |
| <a class="gameicon-link" href="https://retroachievements.org/game/11360" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/052085.png" alt="Digimon World 2 (PlayStation)"> <span>Digimon World 2 (PlayStation)</span></a>                                                          | {% rauserpic shauntmw %}  | [Guide](https://github.com/RetroAchievements/guides/wiki/Digimon-World-2-(PlayStation))                            |
| <a class="gameicon-link" href="https://retroachievements.org/game/1412" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/062598.png" alt="Ogre Battle: The March of the Black Queen (SNES)"> <span>Ogre Battle: The March of the Black Queen (SNES)</span></a>                     | {% rauserpic Sines %}     | [Guide](https://github.com/RetroAchievements/guides/wiki/Ogre-Battle:-March-of-the-Black-Queen-(SNES))             |
| <a class="gameicon-link" href="https://retroachievements.org/game/5371" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/046977.png" alt="Legend of Zelda, The: Link's Awakening DX (Game Boy Color)"> <span>Legend of Zelda, The: Link's Awakening DX (Game Boy Color)</span></a> | {% rauserpic Nepiki %}    | [Guide](https://github.com/RetroAchievements/guides/wiki/The-Legend-of-Zelda,-Links-Awakening-DX-(Game-Boy-Color)) |
| <a class="gameicon-link" href="https://retroachievements.org/game/2945" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/061840.png" alt="Go Go Ackman (SNES)"> <span>Go Go Ackman (SNES)</span></a>                                                                               | {% rauserpic Glendaal %}  | [Guide](https://github.com/RetroAchievements/guides/wiki/Go-Go-Ackman-achievement-guide-and-roadmap)               |
| <a class="gameicon-link" href="https://retroachievements.org/game/19538" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/059359.png" alt="~Hack~ The Legend of Zelda: Shadow of Night (NES)"> <span>~Hack~ The Legend of Zelda: Shadow of Night (NES)</span></a>                  | {% rauserpic suspect15 %} | [Guide](https://github.com/RetroAchievements/guides/wiki/~Hack~-The-Legend-of-Zelda:-Shadow-of-Night-(NES))        |
| <a class="gameicon-link" href="https://retroachievements.org/game/1529" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/045494.png" alt="The Adventures of Dino Riki (NES)"> <span>The Adventures of Dino Riki (NES)</span></a>                                                   | {% rauserpic Glendaal %}  | [Guide](https://github.com/RetroAchievements/guides/wiki/Adventures-of-Dino-Riki-achievement-guide-roadmap)        |
| <a class="gameicon-link" href="https://retroachievements.org/game/14512" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/041203.png" alt="Dragon Force (Sega Saturn)"> <span>Dragon Force (Sega Saturn)</span></a>                                                                | {% rauserpic suspect15 %} | [Guide](https://github.com/RetroAchievements/guides/wiki/Dragon-Force-(Saturn))                                    |
| <a class="gameicon-link" href="https://retroachievements.org/game/11249" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/048353.png" alt="Valkyrie Profile (PlayStation)"> <span>Valkyrie Profile (PlayStation)</span></a>                                                        | {% rauserpic Sines %}     | [Guide](https://github.com/RetroAchievements/guides/wiki/Valkyrie-Profile-(Playstation))                           |
| <a class="gameicon-link" href="https://retroachievements.org/game/4748" target="_blank" rel="noopener"> <img class="gameicon" src="https://retroachievements.org/Images/017657.png" alt="Shadowrun (Mega Drive)"> <span>Shadowrun (Mega Drive)</span></a>                                                                         | {% rauserpic shauntmw %}  | [Guide](https://github.com/RetroAchievements/guides/wiki/Shadowrun-(Mega-Drive))                                   |
...
Huge thanks to {% rauserpic luchaos %} and {% rauserpic Jamiras %} for their insane amout of consistent support on RAWeb with maintaining the repo, addressing Pull Requests, deploying new updates, and providing overall maintenance on the site. And thanks to everyone who contributed to RAWeb over the past year:
