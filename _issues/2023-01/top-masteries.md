...
| Arcade                      | {% rauserpic Wendigo%}                                                         | 61             | <!-- 27  --> |
| Arduboy                     | {% rauserpic HolyShinx %}                                                      | 35             | <!-- 71  --> |
| Atari 2600                  | {% rauserpic PMniac %}                                                         | 99             | <!-- 25  --> |
...
| Fairchild Channel F         | {% rauserpic alphacrust %} & {% rauserpic Stomper %}                           | 21             | <!-- 57  --> |
| Game Boy                    | {% rauserpic Shootzy %}                                                        | 126            | <!-- 4   --> |
| Game Boy Advance            | {% rauserpic bonecrusher1022 %}                                                | 121            | <!-- 5   --> |
| Game Boy Color              | {% rauserpic pitapocket17 %}                                                   | 92             | <!-- 6   --> |
| Game Gear                   | {% rauserpic Nydaxn %}                                                         | 67             | <!-- 15  --> |
| Hack Champ                  | {% rauserpic HolyShinx %}                                                      | 207            | <!--     --> |
| Homebrew Champ              | {% rauserpic AuburnRDM %}                                                      | 185            | <!--     --> |
| Intellivision               | {% rauserpic guineu %} & {% rauserpic Jungon %}                                | 14             | <!-- 45  --> |
| Magnavox Odyssey 2          | {% rauserpic Jungon %}                                                         | 8              | <!-- 23  --> |
| Master System               | {% rauserpic Jungon %}                                                         | 80             | <!-- 11  --> |
| Mega Drive                  | {% rauserpic DUT %}                                                            | 134            | <!-- 1   --> |
...
| Nintendo DS                 | {% rauserpic Olafur %}                                                         | 77             | <!-- 18  --> |
| PC Engine                   | {% rauserpic Infernum %}                                                       | 34             | <!-- 8   --> |
| PC Engine CD                | {% rauserpic Infernum %}                                                       | 10             | <!-- 76  --> |
| PC-8000/8800                | {% rauserpic Orph %}                                                           | 12             | <!-- 47  --> |
| PC-FX                       | {% rauserpic Annonith %} & {% rauserpic YahwehTzVaoth %}                       | 4              | <!-- 49  --> |
| PlayStation                 | {% rauserpic FBiDev %}                                                         | 85             | <!-- 12  --> |
| PlayStation 2               | {% rauserpic donutweegee %} & {% rauserpic Infernum %}                         | 25             | <!-- 21  --> |
| PlayStation Portable        | {% rauserpic minibt %}                                                         | 37             | <!-- 41  --> |
| Pokémon Mini                | {% rauserpic Sylrifaide %}                                                     | 35             | <!-- 24  --> |
...
| SNES                        | {% rauserpic danibodom %}                                                      | 208            | <!-- 3   --> |
| Vectrex                     | {% rauserpic Jungon %}                                                         | 9              | <!-- 46  --> |
| Virtual Boy                 | {% rauserpic Jungon %}                                                         | 14             | <!-- 28  --> |
| WASM-4                      | {% rauserpic AuburnRDM %}                                                      | 31             | <!-- 72  --> |
| Watara Supervision          | {% rauserpic AzuchiAkeshi %}                                                   | 46             | <!-- 63  --> |
