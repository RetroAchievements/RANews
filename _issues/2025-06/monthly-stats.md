...
| Number of mastery awards awarded.                                | 23,375     | <!-- 04 -->
| Number of beaten awards awarded.                                 | 41,768     | <!-- 04B -->
| Number of set requests made.                                     | 7,764      | <!-- 05 -->
| Number of leaderboards created.                                  | 3,024      | <!-- 06 -->
| Number of leaderboard entries submitted.                         | 529,760    | <!-- 07 -->
| Number of users who have earned at least 1 hardcore achievement. | 41,484     | <!-- 08 -->
| Number of total hardcore points earned by players.               | 16,115,087 | <!-- 09 -->
| Number of total hardcore retro points earned by players.         | 63,030,254 | <!-- 09 -->
| Number of user accounts created.                                 | 36,846     | <!-- 10 -->
| Number of new user accounts reaching ranked status.              | 652        | <!-- 10 -->
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Unlocks</th></tr></thead><tbody>
        ...
        <tr><td>WASM-4                      </td><td>   2,531</td></tr>
...
| Rank | Achievement                                                               | Game                                                                         | Times Awarded |
| :--- | :------------------------------------------------------------------------ | :--------------------------------------------------------------------------- | :------------ |
| 1    | {% raachpic 490239, 49740, A Sword is Not Strength %}                     | {% ragamepic 32718, 106174, Achievement of the Week 2025 %}                  | 815           |
| 2    | {% raachpic 509639, 577047, City Escape %}                                | {% ragamepic 3779, 066012, Sonic Adventure 2: Battle %}                      | 501           |
| 3    | {% raachpic 510100, 578668, Brotherly Rivalry %}                          | {% ragamepic 33398, 110122, ~Hack~ Super Mariomon %}                         | 453           |
| 4    | {% raachpic 495226, 572690, Bugz %}                                       | {% ragamepic 32847, 107626, RA Roulette 2025 %}                              | 391           |
| 5    | {% raachpic 520332, 589293, So Happy! %}                                  | {% ragamepic 17494, 112116, ~Hack~ Banjo-Kazooie: Nostalgia 64 %}            | 256           |
| 6    | {% raachpic 493747, 129308, Bug Catcher %}                                | {% ragamepic 32836, 110842, RA Roulette 2023 - Evergreen %}                  | 213           |
| 7    | {% raachpic 517072, 585132, Ace of Diamonds %}                            | {% ragamepic 33246, 111634, ~Hack~ BAZR %}                                   | 199           |
| 8    | {% raachpic 494260, 46760, Bowser Disposer %}                             | {% ragamepic 32838, 110940, RA Roulette 2024 - Evergreen %}                  | 186           |
| 9    | {% raachpic 512730, 588933, Simple and Clear %}                           | {% ragamepic 32650, 112095, Kingdom Hearts %}                                | 168           |
| 10   | {% raachpic 514821, 583749, Rock Solid Start %}                           | {% ragamepic 18444, 110929, ~Hack~ Pokemon Yellow Legacy %}                  | 154           |
| 11   | {% raachpic 519511, 588026, Smart Plumber %}                              | {% ragamepic 3230, 049803, Mario's Early Years: Preschool Fun %}             | 153           |
| 12   | {% raachpic 502624, 570107, First Step to Victory %}                      | {% ragamepic 30894, 101849, ~Hack~ Pokemon Emerald Seaglass %}               | 150           |
| 13   | {% raachpic 511885, 573459, Bedroom Blitz %}                              | {% ragamepic 3887, 104482, Pok̩mon Black Version %}                         | 145           |
| 14   | {% raachpic 506679, 586105, I Don't Want to Join the Air Force %}         | {% ragamepic 3127, 112122, Ace Combat 04: Shattered Skies %}                 | 140           |
| 15   | {% raachpic 521544, 558148, Holy Grail %}                                 | {% ragamepic 33627, 112449, RAD 2025 %}                                      | 140           |
| 16   | {% raachpic 492521, 558146, Recognized Talent %}                          | {% ragamepic 32817, 106550, ~Homebrew~ Inventory Full %}                     | 139           |
| 17   | {% raachpic 516421, 588531, Obligatory Cartoon Reference %}               | {% ragamepic 10075, 110715, Donkey Kong 64 %}                                | 137           |
| 18   | {% raachpic 512850, 585449, Mushroom to Learn %}                          | {% ragamepic 29759, 106372, ~Hack~ Mario Kart: Double Dash Extended %}       | 134           |
| 19   | {% raachpic 495769, 561113, Timber!! %}                                   | {% ragamepic 32909, 107179, Terraria %}                                      | 130           |
| 20   | {% raachpic 514446, 123700, What Is This, Some Kind of Learning Game?! %} | {% ragamepic 33480, 110923, Achievement of the Week 2018 - Evergreen %}      | 122           |
| 21   | {% raachpic 517235, 585387, Where Am I? %}                                | {% ragamepic 33578, 111619, ~Homebrew~ 204863: A P.T. Silent Hills Demake %} | 119           |
| 22   | {% raachpic 517037, 585096, Thank You, Stranger! %}                       | {% ragamepic 33577, 111512, ~Homebrew~ Fable: 20th Anniversary Demake %}     | 118           |
| 23   | {% raachpic 510905, 578088, Small Mario Vs Small Bowser %}                | {% ragamepic 11729, 046594, New Super Mario Bros. %}                         | 110           |
| 24   | {% raachpic 516561, 585245, Getting It Dune %}                            | {% ragamepic 2623, 062824, TimeSplitters %}                                  | 106           |
| 25   | {% raachpic 520887, 590010, Foot in the Door %}                           | {% ragamepic 14204, 105220, Midnight Club: L.A. Remix %}                     | 105           |
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Notes</th></tr></thead><tbody>
        <tr><td>32X                         </td><td>    73</td></tr>
        <tr><td>3DO Interactive Multiplayer </td><td>    28</td></tr>
        <tr><td>Amstrad CPC                 </td><td>    68</td></tr>
        <tr><td>Apple II                    </td><td>    17</td></tr>
        <tr><td>Arcade                      </td><td>   445</td></tr>
        <tr><td>Arcadia 2001                </td><td>    10</td></tr>
        <tr><td>Arduboy                     </td><td>    25</td></tr>
        <tr><td>Atari 2600                  </td><td>    56</td></tr>
        <tr><td>Atari 7800                  </td><td>    42</td></tr>
        <tr><td>DOS                         </td><td>   144</td></tr>
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Awards</th></tr></thead><tbody>
        ...
        <tr><td>Watara Supervision          </td><td>    38</td></tr>
        <tr><td>WonderSwan                  </td><td>    68</td></tr>
    </tbody></table>
    </div>
</div>
<br clear="left"/>
...
| Number of tickets created.                     | 1,579 | <!-- A -->
| Number of tickets triggered at the wrong time. | 347   | <!-- B -->
| Number of tickets did not trigger.             | 1,232 | <!-- C -->
| Number of tickets resolved.                    | 690   | <!-- D -->
| Number of tickets closed.                      | 640   | <!-- E -->
