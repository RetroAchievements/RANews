...
| 3DO Interactive Multiplayer | {% rauserpic guineu %}                                                                                         | 8              | <!-- 43  --> |
| Amstrad CPC                 | {% rauserpic roukanumachi %}                                                                                   | 14             | <!-- 37  --> |
| Apple II                    | {% rauserpic guineu %}                                                                                         | 12             | <!-- 38  --> |
| Arcade                      | {% rauserpic dcmpinguin%}                                                                                      | 59             | <!-- 27  --> |
...
| Fairchild Channel F         | {% rauserpic alphacrust %} & {% rauserpic AuburnRDM %}                                                         | 18             | <!-- 57  --> |
| Game Boy                    | {% rauserpic Shootzy %}                                                                                        | 125            | <!-- 4   --> |
| Game Boy Advance            | {% rauserpic bonecrusher1022 %}                                                                                | 109            | <!-- 5   --> |
| Game Boy Color              | {% rauserpic pitapocket17 %}                                                                                   | 57             | <!-- 6   --> |
| Game Gear                   | {% rauserpic Nydaxn %}                                                                                         | 62             | <!-- 15  --> |
| Hack Champ                  | {% rauserpic HolyShinx %}                                                                                      | 198            | <!--     --> |
| Homebrew Champ              | {% rauserpic AuburnRDM %}                                                                                      | 166            | <!--     --> |
| Intellivision               | {% rauserpic Jungon %}                                                                                         | 14             | <!-- 45  --> |
| Magnavox Odyssey 2          | {% rauserpic Jungon %}                                                                                         | 7              | <!-- 23  --> |
| Master System               | {% rauserpic Jungon %}                                                                                         | 74             | <!-- 11  --> |
| Mega Drive                  | {% rauserpic DUT %}                                                                                            | 119            | <!-- 1   --> |
| Mega Duck                   | {% rauserpic Infernum %}, {% rauserpic Jaeger42 %}, {% rauserpic soltyd %} & {%  rauserpic TheRealBillHicks %} | 4              | <!-- 69  --> |
| MSX                         | {% rauserpic guineu %}                                                                                         | 8              | <!-- 29  --> |
| Nintendo 64                 | {% rauserpic BenTobitt %}                                                                                      | 45             | <!-- 2   --> |
| Neo Geo Pocket              | {% rauserpic MelodyAsh %}                                                                                      | 7              | <!-- 14  --> |
| NES                         | {% rauserpic SanMarino %}                                                                                      | 241            | <!-- 7   --> |
| Nintendo DS                 | {% rauserpic Olafur %}                                                                                         | 68             | <!-- 18  --> |
...
| PlayStation                 | {% rauserpic FBiDev %}                                                                                         | 80             | <!-- 12  --> |
