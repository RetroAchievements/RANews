...
- Current Winners:
    - Month 19: {% rauserpic AuburnRDM %} and {% rauserpic televandalist %}
- Previous Winners:
...
- Daily Distractions Season 1 winners with 90 points:
  - {% rauserpic Akai %}
  - {% rauserpic Ideasds %}
  - {% rauserpic NEOMAR %}
  - {% rauserpic Olafur %}
...
- Currently 1st place (with 116 points):
  - {% rauserpic AuburnRDM %}
