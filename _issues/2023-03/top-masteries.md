...
| Event Awards                | {% rauserpic freezestar %}<br>{% rauserpic Hotscrock %}                                                                                                                | 18             | <!-- 101 --> |
| Site Awards                 | {% rauserpic Snow %}<br>{% rauserpic televandalist %}                                                                                                                  | 23             | <!-- 101 --> |
...
| Arcade                      | {% rauserpic Wendigo%}                                                                                                                                                 | 65             | <!-- 27  --> |
| Arduboy                     | {% rauserpic guineu %}                                                                                                                                                 | 36             | <!-- 71  --> |
| Atari 2600                  | {% rauserpic PMniac %}                                                                                                                                                 | 105            | <!-- 25  --> |
| Atari 7800                  | {% rauserpic PMniac %}                                                                                                                                                 | 13             | <!-- 51  --> |
| Atari Jaguar                | {% rauserpic PMniac %}                                                                                                                                                 | 7              | <!-- 17  --> |
| Atari Lynx                  | {% rauserpic guineu %}<br>{% rauserpic Jungon %}                                                                                                                       | 5              | <!-- 13  --> |
| ColecoVision                | {% rauserpic PMniac %}                                                                                                                                                 | 14             | <!-- 44  --> |
| Dreamcast                   | {% rauserpic SteveHarvey %}                                                                                                                                            | 19             | <!-- 40  --> |
| Fairchild Channel F         | {% rauserpic Maximdraco %}                                                                                                                                             | 24             | <!-- 57  --> |
| Game Boy                    | {% rauserpic Shootzy %}                                                                                                                                                | 129            | <!-- 4   --> |
| Game Boy Advance            | {% rauserpic bonecrusher1022 %}                                                                                                                                        | 128            | <!-- 5   --> |
| Game Boy Color              | {% rauserpic pitapocket17 %}                                                                                                                                           | 96             | <!-- 6   --> |
| Game Gear                   | {% rauserpic Nydaxn %}                                                                                                                                                 | 73             | <!-- 15  --> |
| Hack Champ                  | {% rauserpic HolyShinx %}                                                                                                                                              | 213            | <!--     --> |
| Homebrew Champ              | {% rauserpic AuburnRDM %}                                                                                                                                              | 203            | <!--     --> |
| Intellivision               | {% rauserpic Jungon %}                                                                                                                                                 | 17             | <!-- 45  --> |
| Magnavox Odyssey 2          | {% rauserpic Jungon %}                                                                                                                                                 | 8              | <!-- 23  --> |
| Master System               | {% rauserpic Jungon %}                                                                                                                                                 | 82             | <!-- 11  --> |
| Mega Drive                  | {% rauserpic DUT %}                                                                                                                                                    | 133            | <!-- 1   --> |
| Mega Duck                   | {% rauserpic AzuchiAkeshi %}                                                                                                                                           | 12             | <!-- 69  --> |
| MSX                         | {% rauserpic guineu %}                                                                                                                                                 | 14             | <!-- 29  --> |
| Nintendo 64                 | {% rauserpic BenTobitt %}                                                                                                                                              | 47             | <!-- 2   --> |
| Neo Geo Pocket              | {% rauserpic MelodyAsh %}                                                                                                                                              | 9              | <!-- 14  --> |
| NES                         | {% rauserpic SanMarino %}                                                                                                                                              | 244            | <!-- 7   --> |
| Nintendo DS                 | {% rauserpic Olafur %}                                                                                                                                                 | 78             | <!-- 18  --> |
| PC Engine                   | {% rauserpic Infernum %}                                                                                                                                               | 36             | <!-- 8   --> |
| PC Engine CD                | {% rauserpic Annonith %}                                                                                                                                               | 10             | <!-- 76  --> |
| PC-8000/8800                | {% rauserpic Orph %}                                                                                                                                                   | 14             | <!-- 47  --> |
| PC-FX                       | {% rauserpic guineu %}                                                                                                                                                 | 6              | <!-- 49  --> |
| PlayStation                 | {% rauserpic FBiDev %}                                                                                                                                                 | 90             | <!-- 12  --> |
| PlayStation 2               | {% rauserpic Infernum %}                                                                                                                                               | 29             | <!-- 21  --> |
| PlayStation Portable        | {% rauserpic minibt %}                                                                                                                                                 | 38             | <!-- 41  --> |
| Pokémon Mini                | {% rauserpic Sylrifaide %}                                                                                                                                             | 36             | <!-- 24  --> |
| Sega 32X                    | {% rauserpic DUT %}<br>{% rauserpic Nevanos %}                                                                                                                         | 3              | <!-- 10  --> |
| Sega Saturn                 | {% rauserpic Orph %}                                                                                                                                                   | 16             | <!-- 39  --> |
| Sega CD                     | {% rauserpic Drakub %}                                                                                                                                                 | 14             | <!-- 9   --> |
| SG-1000                     | {% rauserpic Jungon %}                                                                                                                                                 | 12             | <!-- 33  --> |
| SNES                        | {% rauserpic danibodom %}                                                                                                                                              | 213            | <!-- 3   --> |
| Vectrex                     | {% rauserpic Jungon %}                                                                                                                                                 | 9              | <!-- 46  --> |
| Virtual Boy                 | {% rauserpic Grahamtams %}                                                                                                                                             | 15             | <!-- 28  --> |
| WASM-4                      | {% rauserpic AuburnRDM %}                                                                                                                                              | 33             | <!-- 72  --> |
| Watara Supervision          | {% rauserpic AzuchiAkeshi %}                                                                                                                                           | 47             | <!-- 63  --> |
| WonderSwan                  | {% rauserpic Amir96lx %}<br>{% rauserpic Annonith %}<br>{% rauserpic AuburnRDM %}<br>{% rauserpic Grahamtams %}<br>{% rauserpic Nanashi %}<br>{% rauserpic Pixelach %} | 3              | <!-- 53  --> |
