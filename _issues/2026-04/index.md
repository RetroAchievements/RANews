...
<div class="section-link">
    <a href="./raguide.html">
        <div class="section-content">
            ...
            <p>Survive the deadly corridors of space with the latest RAGuide for Iron Helix on the Sega CD. Trapped aboard a virus-infected ship name Indiana, take control of a zoological robot sent over to explore, collected DNA sample and solve challendes its many challenges.</p>
        </div>
    </a>
...
<div class="section-link">
    <a href="./spot-the-difference.html">
        <div class="section-content">
            ...
            <p>In this section, we challenge readers to put their observation skills to the test with a Spot the Difference game created by SporyTike for the game Super Paper Mario. There are 10 differences to find, and readers who spot them all will be featured in the next issue. So sharpen your eyes and get ready for some fun!</p>
        </div>
    </a>
</div>
<div class="section-link">
