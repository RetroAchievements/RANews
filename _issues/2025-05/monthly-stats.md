...
| Number of sets released.                                         | 122        | <!-- Get from Hot Cheevs -->
| Number of achievements released.                                 | 3,980      | <!-- 01 -->
| Number of hardcore achievements earned.                          | 2,344,903  | <!-- 02 -->
| Number of code notes created.                                    | 14,849     | <!-- 03 -->
| Number of mastery awards awarded.                                | 21,797     | <!-- 04 -->
| Number of beaten awards awarded.                                 | 38,999     | <!-- 04B -->
| Number of set requests made.                                     | 8,460      | <!-- 05 -->
| Number of leaderboards created.                                  | 1,918      | <!-- 06 -->
| Number of leaderboard entries submitted.                         | 469,236    | <!-- 07 -->
| Number of users who have earned at least 1 hardcore achievement. | 40,840     | <!-- 08 -->
| Number of total hardcore points earned by players.               | 15,331,062 | <!-- 09 -->
| Number of total hardcore retro points earned by players.         | 58,760,811 | <!-- 09 -->
| Number of user accounts created.                                 | 37,788     | <!-- 10 -->
| Number of new user accounts reaching ranked status.              | 705        | <!-- 10 -->
...
| 23   | {% rauserpicalt Brylefi, Bryan1150 %}      | 61           |
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Unlocks</th></tr></thead><tbody>
        ...
        <tr><td>WASM-4                      </td><td>   3,017</td></tr>
...
| 1    | {% raachpic 510100, 578668, Brotherly Rivalry %}                          | {% ragamepic 33398, 110122, ~Hack~ Super Mariomon %}                               | 1,423         |
| 2    | {% raachpic 490236, 412123, Cookie Mountain Crumbled %}                   | {% ragamepic 32718, 106174, Achievement of the Week 2025 %}                        | 946           |
| 3    | {% raachpic 509032, 337572, Coin 1000 %}                                  | {% ragamepic 33395, 110006, Ultimate Evergreen Stimulus EX+ %}                     | 927           |
| 4    | {% raachpic 495210, 530902, Freshman Year in the Books %}                 | {% ragamepic 32847, 107626, RA Roulette 2025 %}                                    | 328           |
| 5    | {% raachpic 493747, 129308, Bug Catcher %}                                | {% ragamepic 32836, 110842, RA Roulette 2023 - Evergreen %}                        | 227           |
| 6    | {% raachpic 502624, 570107, First Step to Victory %}                      | {% ragamepic 30894, 101849, ~Hack~ Pokemon Emerald Seaglass %}                     | 199           |
| 7    | {% raachpic 494260, 46760, Bowser Disposer %}                             | {% ragamepic 32838, 110940, RA Roulette 2024 - Evergreen %}                        | 194           |
| 8    | {% raachpic 510905, 578088, Small Mario Vs Small Bowser %}                | {% ragamepic 11729, 046594, New Super Mario Bros. %}                               | 192           |
| 9    | {% raachpic 511885, 573459, Bedroom Blitz %}                              | {% ragamepic 3887, 104482, Pokémon Black Version %}                                | 180           |
| 10   | {% raachpic 504626, 571873, Ante Up! %}                                   | {% ragamepic 3320, 109604, Mercenaries: Playground of Destruction %}               | 150           |
| 11   | {% raachpic 495769, 561113, Timber!! %}                                   | {% ragamepic 32909, 107179, Terraria %}                                            | 139           |
| 12   | {% raachpic 514446, 123700, What Is This, Some Kind of Learning Game?! %} | {% ragamepic 33480, 110923, Achievement of the Week 2018 - Evergreen %}            | 136           |
| 13   | {% raachpic 510232, 577427, Westopolis %}                                 | {% ragamepic 6354, 100252, Shadow the Hedgehog %}                                  | 120           |
| 14   | {% raachpic 508582, 576146, Spot XIII %}                                  | {% ragamepic 33104, 109864, Find the Pixel 2025 %}                                 | 108           |
| 15   | {% raachpic 514821, 583749, Rock Solid Start %}                           | {% ragamepic 18444, 110929, ~Hack~ Pokemon Yellow Legacy %}                        | 96            |
| 16   | {% raachpic 490602, 555676, Burning Angels %}                             | {% ragamepic 20255, 072251, Sonic Mega Collection Plus %}                          | 94            |
| 17   | {% raachpic 503491, 576900, Not So Long Ago %}                            | {% ragamepic 32995, 109534, ~Hack~ Castlevania: Symphony of the Night - Reborn %}  | 92            |
| 18   | {% raachpic 493429, 46583, Special Sorta Person %}                        | {% ragamepic 32833, 106758, Achievement of the Week 2016 - Evergreen %}            | 92            |
| 19   | {% raachpic 510964, 578187, Root Cleaner %}                               | {% ragamepic 25391, 080909, ~Homebrew~ Bug Bites! %}                               | 91            |
| 20   | {% raachpic 496379, 561373, Hey Tails! %}                                 | {% ragamepic 6333, 103041, Sonic Adventure DX %}                                   | 88            |
| 21   | {% raachpic 513211, 580811, Egg-stinction Event %}                        | {% ragamepic 16387, 110657, ~Homebrew~ Luigi Puzzle %}                             | 88            |
| 22   | {% raachpic 494981, 579252, The Champion of the Struggle Tournament %}    | {% ragamepic 32564, 109215, Kingdom Hearts II %}                                   | 85            |
| 23   | {% raachpic 502508, 569915, Quest for Masters %}                          | {% ragamepic 11202, 048069, The Legend of Zelda: Ocarina of Time - Master Quest %} | 78            |
| 24   | {% raachpic 498756, 565463, A Little Unfair... For Them %}                | {% ragamepic 9602, 081455, Super Smash Bros. Melee %}                              | 76            |
| 25   | {% raachpic 512813, 581289, Flaming Moe's %}                              | {% ragamepic 6343, 110602, The Simpsons: Road Rage %}                              | 74            |
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Awards</th></tr></thead><tbody>
        ...
        <tr><td>WonderSwan                  </td><td>    72</td></tr>
    </tbody></table>
    </div>
</div>
<br clear="left"/>
...
| Number of tickets created.                     | 1,450 | <!-- A -->
| Number of tickets triggered at the wrong time. | 315   | <!-- B -->
| Number of tickets did not trigger.             | 1,135 | <!-- C -->
| Number of tickets resolved.                    | 621   | <!-- D -->
| Number of tickets closed.                      | 608   | <!-- E -->
