...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>161 users are tied in first with 7 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>13 users are currently tied in first place with 250 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>384 users are currently tied in first place with 3 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
        ...
        <tr>
            ...
            <td>
                <ol>
                    ...
                    <li value="3">{% rauserpic DeeCee %} - 60 Points</li>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colspan=2>{% ragamepic 7407, 047240, MechWarrior 2: 31st Century Combat - Arcade Combat Edition %}</td>
                        </tr>
                        <tr>
                            <td rowspan=3>{% rauserpic Pikur %}</td>
                        </tr>
                        <tr>
                            <td colspan=2>{% ragamepic 13996, 069467, Chack'n Pop %}</td>
                        </tr>
                        <tr>
                            <td colspan=2>{% ragamepic 4767, 093946, F-1 Race %}</td>
                        </tr>
                        <tr>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic NEOMAR %}<sup>**</sup> - 1483 Points</li>
                    <li value="2">{% rauserpic Lonoke31 %}<sup>**</sup> - 1400 Points</li>
                    <li value="3">{% rauserpic Sutarion %}<sup>**</sup> - 1191 Points</li>
                    <li value="4">{% rauserpic Timmay %}<sup>**</sup> - 1181 Points</li>
                    <li value="5">{% rauserpicalt AmirGaris, Amir96lx %}<sup>**</sup> - 1121 Points</li>
                    <li value="6">{% rauserpic MiningMario %}<sup>**</sup> - 1089 Points</li>
                    <li value="7">{% rauserpic NeoRetroGamer %}<sup>**</sup> - 749 Points</li>
