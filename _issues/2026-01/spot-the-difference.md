...
<table><tbody>
    ...
    <tr>
        ...
        <td colspan="2">{% rauserpic Ohmless %}</td>
    </tr>
</tbody></table>
...
| Game                                         | Console     | Genre       |
| -------------------------------------------- | ----------- | ----------- |
| {% ragamepic 2163, 074452, Pocket Fighter %} | PlayStation | 2D Fighting |


* Suggested by: {% rauserpic JetDusk %}
