...
<div class="section-link">
    <a href="./rapodcast.html">
        <div class="section-content">
            ...
            <p>Join the RetroAchievements community and listen to the latest RAPodcast. This months podcast has our host, TimeCrush, featuring Nepiki, the RA community manager. Listen along as they discuss the state of RA grown and what it's like to manage the every growing community.</p>
        </div>
    </a>
</div>
<div class="section-link">
...
<div class="section-link">
    <a href="./raguide.html">
        <div class="section-content">
            ...
            <p>Charge into the chaos with our latest RAGuide for for Dynasty Warriors 5: Xtreme Legends. Command legendary warriors across brutal battlefields, unlocking powerful weapons, skills, and story paths along the way. With our expert tips, you’ll dominate massive armies, complete challenging objectives, and carve your own legend across the Three Kingdoms</p>
        </div>
    </a>
    ...
    <a href="./radvantage.html">
        <div class="section-content">
            ...
            <p>The Hero’s Door hides Vaati’s most vicious tricks, and doing it hitless is easier with the latest RAdvantage tip. Dodge every swipe, phase shift, and projectile without slipping, and prove you’re a Four Swords.</p>
        </div>
    </a>
</div>
<div class="section-link">
...
<div class="section-link">
    <a href="./spot-the-difference.html">
        <div class="section-content">
            ...
            <p>In this section, we challenge readers to put their observation skills to the test with a Spot the Difference game created by SporyTike for the game Ape Escape. There are 10 differences to find, and readers who spot them all will be featured in the next issue. So sharpen your eyes and get ready for some fun!</p>
        </div>
    </a>
</div>
<div class="section-link">
...
<div class="section-link">
    <div class="section-content">
        ...
        <table><tbody>
            ...
            <tr>
                <td>{% rauserpic AnarchisedLUTE %}</td>
            ...
            <tr>
                <td>{% rauserpic HardSonicStorm %}</td>
            ...
            <tr>
                <td>{% rauserpic The1upBlock %}</td>
                <td>{% rauserpic TimeCrush %}</td>
                <td>{% rauserpic tobesplays %}</td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>{% rauserpic Wispydream %}</td>
                <td>{% rauserpic wizagab %}</td>
            </tr>
            <tr>
