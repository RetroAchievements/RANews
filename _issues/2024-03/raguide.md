...
![Ruby Field](img/RAGuide/Ruby_Field.png) ![Sapphire Field](img/RAGuide/Sapphire_Field.png)
...
| :---------- | :------------------------------------------------------- | :--- | :----------- | :---------------------------------------------------------- |
| Forest      | ![Ruby Forest](img/RAGuide/Pinball_Ruby_Forest.png)      |      | Forest       | ![Sapphire Forest](img/RAGuide/Pinball_Sapphire_Forest.png) |
| Volcano     | ![Volcano](img/RAGuide/Pinball_Ruby_Volcano.png)         |      | Lake         | ![Lake](img/RAGuide/Pinball_Sapphire_Lake.png)              |
| Plains      | ![Ruby Plains](img/RAGuide/Pinball_Ruby_Plains.png)      |      | Plains       | ![Sapphire Plains](img/RAGuide/Pinball_Sapphire_Plains.png) |
| Ocean       | ![Ruby Ocean](img/RAGuide/Pinball_Ruby_Ocean.png)        |      | Wilderness   | ![Wilderness](img/RAGuide/Pinball_Sapphire_Wilderness.png)  |
| Safari Zone | ![Safari Zone](img/RAGuide/Pinball_Ruby_Safari_Zone.png) |      | Ocean        | ![Sapphire Ocean](img/RAGuide/Pinball_Sapphire_Ocean.png)   |
| Cave        | ![Ruby Cave](img/RAGuide/Pinball_Ruby_Cave.png)          |      | Cave         | ![Sapphire Cave](img/RAGuide/Pinball_Sapphire_Cave.png)     |
...
| :------------------- | :---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | :-------- | :------------------------------------------------------------------------------ |
| 30 second Ball Saver | ![30s Ball Saver](img/RAGuide/Pinball_RS_30_Sec_Ball_Saver.png)                                                                                                                                       | 10        |                                                                                 |
| 60 second Ball Saver | ![60s Ball Saver](img/RAGuide/Pinball_RS_60_Sec_Ball_Saver.png)                                                                                                                                       | 20        |                                                                                 |
| 90 second Ball Saver | ![90s Ball Saver](img/RAGuide/Pinball_RS_90_Sec_Ball_Saver.png)                                                                                                                                       | 30        |                                                                                 |
| Ball Upgrade         | ![Great Upgrade](img/RAGuide/Pinball_RS_Ball_Upgrade_Great.png) / ![Ultra Upgrade](img/RAGuide/Pinball_RS_Ball_Upgrade_Ultra.png) / ![Master Upgrade](img/RAGuide/Pinball_RS_Ball_Upgrade_Master.png) | 40        | Upgrades your ball one level                                                    |
| Timer Up             | ![Timer Up](img/RAGuide/Pinball_RS_Timer_Up.png)                                                                                                                                                      | 40        | Adds 30s to the next timed event                                                |
| Pika                 | ![Pika Upgrade](img/RAGuide/Pinball_RS_Pika_Saver.png)                                                                                                                                                | 50        | Pichu joins Pikachu. They remain fully charged for the rest of the current ball |
| Bonus Challenge      | ![Pelipper Bonus Challange](img/RAGuide/Pinball_RS_Spheal_Bonus_Pelipper.png) / ![Whiscash Bonus Challange](img/RAGuide/Pinball_RS_Spheal_Bonus_Whiscash.png)                                         | 60        | Primes Whiscash/Pelipper to take you to the Spheal BONUS stage                  |
| Extra Ball           | ![Extra Ball](img/RAGuide/Pinball_RS_Extra_Ball.png)                                                                                                                                                  | 99        |                                                                                 |
...
Get Max Upgrade ![Max Upgrade](img/RAGuide/Pinball_RS_Max_Up.png) from the HOLE slots while using a Poké or Great Ball. Force-stopping the Slots with Zigzagoon makes this much easier on SAPPHIRE.
...
![Kecleon bonus board](img/RAGuide/Pinball_RS_Kecleon_Bonus.png)
...
![Duskull and Dusclops bonus board](img/RAGuide/Pinball_RS_Dusclops_Bonus_Stage_Duskull.png)
...
![Groudon bonus board](img/RAGuide/Pinball_RS_Groudon_Stage.png)
...
![Kyogre bonus board](img/RAGuide/Pinball_RS_Kyogre_Stage.png)
...
![Rayquaza bonus board](img/RAGuide/Pinball_RS_Rayquaza_Bonus.png)
...
![Spheal and Sealeo bonus board](img/RAGuide/Pinball_RS_Spheal_Sealeo_Bonus_Stage.png)
...
Treecko can be caught in Forest ![Forest icon](img/RAGuide/Pinball_Ruby_Forest.png) with 3 arrows on RUBY.

| {% raachpic 21386, 21325, Blaziken (5) %} | Fully evolve Torchic |

Torchic can be caught in Volcano ![Volcano icon](img/RAGuide/Pinball_Ruby_Volcano.png) with 3 arrows on Ruby.

| {% raachpic 21385, 21324, Swampert (5) %} | Fully evolve Mudkip |

Mudkip can be caught in Lake ![Lake icon](img/RAGuide/Pinball_Sapphire_Lake.png) with 3 arrows on SAPPHIRE.

| {% raachpic 21384, 21323, Beautox (5) %} | Fully evolve Wurmple to both Beautifly and Dustox |

Wurmple can be hatched on any board. It evolves randomly into either Silcoon or Cascoon, both of which can be caught in Forest ![Forest icon](img/RAGuide/Pinball_Ruby_Forest.png)/![Forest icon](img/RAGuide/Pinball_Sapphire_Forest.png) with 2 arrows on either board. Evolve Silcoon to Get Beautifly and Cascoon for Dustox.
...
Slakoth can be caught in Forest ![Forest icon](img/RAGuide/Pinball_Ruby_Forest.png)/![Forest icon](img/RAGuide/Pinball_Sapphire_Forest.png) with 2 arrows on either board.

| {% raachpic 21381, 21320, Alakazam (5) %} | Fully evolve Abra |

Abra can be caught in Cave ![Cave icon](img/RAGuide/Pinball_Ruby_Cave.png)/![Cave icon](img/RAGuide/Pinball_Sapphire_Cave.png) with 3 arrows on either board.

| {% raachpic 21380, 21319, Golem (5) %} | Fully evolve Geodude |

Geodude can be caught in Wilderness ![Wilderness icon](img/RAGuide/Pinball_Sapphire_Wilderness.png) with 3 arrows on SAPPHIRE.
...
Machop can be caught in Cave ![Cave icon](img/RAGuide/Pinball_Ruby_Cave.png)/![Cave icon](img/RAGuide/Pinball_Sapphire_Cave.png) with 2 arrows on either board.
...
| :------ | :--------- | :--------------------------------------------------- | :--------------------- | :-------- | :------------------------ | :-------------------------------------------------------------------------------------------- | :--------- |
| 001     | Treecko    | ![](https://www.serebii.net/pinball_rs/pkmn/001.gif) | Catch 'Em              | RUBY      | Forest                    | ![](img/RAGuide/Pinball_Ruby_Forest.png)                                                      | 3          |
...
| 004     | Torchic    | ![](https://www.serebii.net/pinball_rs/pkmn/004.gif) | Catch 'Em              | RUBY      | Volcano                   | ![](img/RAGuide/Pinball_Ruby_Volcano.png)                                                     | 3          |
...
| 007     | Mudkip     | ![](https://www.serebii.net/pinball_rs/pkmn/007.gif) | Catch 'Em              | SAPPHIRE  | Lake                      | ![](img/RAGuide/Pinball_Sapphire_Lake.png)                                                    | 3          |
...
| 010     | Poochyena  | ![](https://www.serebii.net/pinball_rs/pkmn/010.gif) | Catch 'Em              | ANY       | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)![](img/RAGuide/Pinball_Sapphire_Plains.png)          | 3          |
| 011     | Mightyena  | ![](https://www.serebii.net/pinball_rs/pkmn/011.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 012     | Zigzagoon  | ![](https://www.serebii.net/pinball_rs/pkmn/012.gif) | Catch 'Em              | ANY       | Forest                    | ![](img/RAGuide/Pinball_Ruby_Forest.png)![](img/RAGuide/Pinball_Sapphire_Forest.png)          | 2          |
...
| 015     | Silcoon    | ![](https://www.serebii.net/pinball_rs/pkmn/015.gif) | Catch 'Em or Evolution | ANY       | Forest                    | ![](img/RAGuide/Pinball_Ruby_Forest.png)![](img/RAGuide/Pinball_Sapphire_Forest.png)          | 2          |
| 016     | Beautifly  | ![](https://www.serebii.net/pinball_rs/pkmn/016.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 017     | Cascoon    | ![](https://www.serebii.net/pinball_rs/pkmn/017.gif) | Catch 'Em or Evolution | ANY       | Forest                    | ![](img/RAGuide/Pinball_Ruby_Forest.png)![](img/RAGuide/Pinball_Sapphire_Forest.png)          | 2          |
...
| 020     | Lombre     | ![](https://www.serebii.net/pinball_rs/pkmn/020.gif) | Catch 'Em or Evolution | SAPPHIRE  | Lake                      | ![](img/RAGuide/Pinball_Sapphire_Lake.png)                                                    | 2          |
...
| 023     | Nuzleaf    | ![](https://www.serebii.net/pinball_rs/pkmn/023.gif) | Catch 'Em or Evolution | RUBY      | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)                                                      | 2          |
| 024     | Shiftry    | ![](https://www.serebii.net/pinball_rs/pkmn/024.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 025     | Tailow     | ![](https://www.serebii.net/pinball_rs/pkmn/025.gif) | Catch 'Em              | ANY       | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)![](img/RAGuide/Pinball_Sapphire_Plains.png)          | 2          |
| 026     | Swellow    | ![](https://www.serebii.net/pinball_rs/pkmn/026.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 027     | Wingull    | ![](https://www.serebii.net/pinball_rs/pkmn/027.gif) | Catch 'Em              | ANY       | Ocean                     | ![](img/RAGuide/Pinball_Ruby_Ocean.png)![](img/RAGuide/Pinball_Sapphire_Ocean.png)            | 2          |
...
| 036     | Slakoth    | ![](https://www.serebii.net/pinball_rs/pkmn/036.gif) | Catch 'Em              | ANY       | Forest                    | ![](img/RAGuide/Pinball_Ruby_Forest.png)![](img/RAGuide/Pinball_Sapphire_Forest.png)          | 2          |
...
| 039     | Abra       | ![](https://www.serebii.net/pinball_rs/pkmn/039.gif) | Catch 'Em              | ANY       | Cave                      | ![](img/RAGuide/Pinball_Ruby_Cave.png)![](img/RAGuide/Pinball_Sapphire_Cave.png)              | 3          |
...
| 042     | Nincada    | ![](https://www.serebii.net/pinball_rs/pkmn/042.gif) | Catch 'Em              | ANY       | Forest                    | ![](img/RAGuide/Pinball_Ruby_Forest.png)![](img/RAGuide/Pinball_Sapphire_Forest.png)          | 3          |
...
| 046     | Loudred    | ![](https://www.serebii.net/pinball_rs/pkmn/046.gif) | Catch 'Em or Evolution | ANY       | Cave                      | ![](img/RAGuide/Pinball_Ruby_Cave.png)![](img/RAGuide/Pinball_Sapphire_Cave.png)              | 2          |
| 047     | Exploud    | ![](https://www.serebii.net/pinball_rs/pkmn/047.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 048     | Makuhita   | ![](https://www.serebii.net/pinball_rs/pkmn/048.gif) | Catch 'Em              | ANY       | Cave                      | ![](img/RAGuide/Pinball_Ruby_Cave.png)![](img/RAGuide/Pinball_Sapphire_Cave.png)              | 2          |
| 049     | Hariyama   | ![](https://www.serebii.net/pinball_rs/pkmn/049.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 050     | Goldeen    | ![](https://www.serebii.net/pinball_rs/pkmn/050.gif) | Catch 'Em              | SAPPHIRE  | Lake                      | ![](img/RAGuide/Pinball_Sapphire_Lake.png)                                                    | 2          |
| 051     | Seaking    | ![](https://www.serebii.net/pinball_rs/pkmn/051.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 052     | Magikarp   | ![](https://www.serebii.net/pinball_rs/pkmn/052.gif) | Catch 'Em              | ANY       | Ocean                     | ![](img/RAGuide/Pinball_Ruby_Ocean.png)![](img/RAGuide/Pinball_Sapphire_Ocean.png)            | 2          |
...
| 055     | Marill     | ![](https://www.serebii.net/pinball_rs/pkmn/055.gif) | Catch 'Em or Evolution | SAPPHIRE  | Lake                      | ![](img/RAGuide/Pinball_Sapphire_Lake.png)                                                    | 3          |
| 056     | Azumarill  | ![](https://www.serebii.net/pinball_rs/pkmn/056.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 057     | Geodude    | ![](https://www.serebii.net/pinball_rs/pkmn/057.gif) | Catch 'Em              | SAPPHIRE  | Wilderness                | ![](img/RAGuide/Pinball_Sapphire_Wilderness.png)                                              | 3          |
...
| 060     | Nosepass   | ![](https://www.serebii.net/pinball_rs/pkmn/060.gif) | Catch 'Em              | ANY       | Cave                      | ![](img/RAGuide/Pinball_Ruby_Cave.png)![](img/RAGuide/Pinball_Sapphire_Cave.png)              | 2          |
...
| 066     | Tentacool  | ![](https://www.serebii.net/pinball_rs/pkmn/066.gif) | Catch 'Em              | ANY       | Ocean                     | ![](img/RAGuide/Pinball_Ruby_Ocean.png)![](img/RAGuide/Pinball_Sapphire_Ocean.png)            | 2          |
| 067     | Tentacruel | ![](https://www.serebii.net/pinball_rs/pkmn/067.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 068     | Sableye    | ![](https://www.serebii.net/pinball_rs/pkmn/068.gif) | Catch 'Em              | SAPPHIRE  | Cave                      | ![](img/RAGuide/Pinball_Sapphire_Cave.png)                                                    | 3          |
| 069     | Mawile     | ![](https://www.serebii.net/pinball_rs/pkmn/069.gif) | Catch 'Em              | RUBY      | Cave                      | ![](img/RAGuide/Pinball_Ruby_Cave.png)                                                        | 3          |
...
| 073     | Machop     | ![](https://www.serebii.net/pinball_rs/pkmn/073.gif) | Catch 'Em              | ANY       | Cave                      | ![](img/RAGuide/Pinball_Ruby_Cave.png)![](img/RAGuide/Pinball_Sapphire_Cave.png)              | 2          |
...
| 076     | Meditite   | ![](https://www.serebii.net/pinball_rs/pkmn/076.gif) | Catch 'Em              | ANY       | Safari Zone or Wilderness | ![](img/RAGuide/Pinball_Ruby_Safari_Zone.png)![](img/RAGuide/Pinball_Sapphire_Wilderness.png) | 2          |
| 077     | Medicham   | ![](https://www.serebii.net/pinball_rs/pkmn/077.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 078     | Electrike  | ![](https://www.serebii.net/pinball_rs/pkmn/078.gif) | Catch 'Em              | ANY       | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)![](img/RAGuide/Pinball_Sapphire_Plains.png)          | 2          |
...
| 082     | Magnemite  | ![](https://www.serebii.net/pinball_rs/pkmn/082.gif) | Catch 'Em              | ANY       | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)![](img/RAGuide/Pinball_Sapphire_Plains.png)          | 2          |
| 083     | Magneton   | ![](https://www.serebii.net/pinball_rs/pkmn/083.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 084     | Voltorb    | ![](https://www.serebii.net/pinball_rs/pkmn/084.gif) | Catch 'Em              | ANY       | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)![](img/RAGuide/Pinball_Sapphire_Plains.png)          | 3          |
| 085     | Electrode  | ![](https://www.serebii.net/pinball_rs/pkmn/085.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 086     | Volbeat    | ![](https://www.serebii.net/pinball_rs/pkmn/086.gif) | Catch 'Em              | RUBY      | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)                                                      | 2          |
| 087     | Illumise   | ![](https://www.serebii.net/pinball_rs/pkmn/087.gif) | Catch 'Em              | SAPPHIRE  | Plains                    | ![](img/RAGuide/Pinball_Sapphire_Plains.png)                                                  | 2          |
...
| 092     | Doduo      | ![](https://www.serebii.net/pinball_rs/pkmn/092.gif) | Catch 'Em              | RUBY      | Safari Zone               | ![](img/RAGuide/Pinball_Ruby_Safari_Zone.png)                                                 | 2          |
| 093     | Dodrio     | ![](https://www.serebii.net/pinball_rs/pkmn/093.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 094     | Roselia    | ![](https://www.serebii.net/pinball_rs/pkmn/094.gif) | Catch 'Em              | ANY       | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)![](img/RAGuide/Pinball_Sapphire_Plains.png)          | 2          |
...
| 097     | Carvanha   | ![](https://www.serebii.net/pinball_rs/pkmn/097.gif) | Catch 'Em              | ANY       | Ocean                     | ![](img/RAGuide/Pinball_Ruby_Ocean.png)![](img/RAGuide/Pinball_Sapphire_Ocean.png)            | 2          |
| 098     | Sharpedo   | ![](https://www.serebii.net/pinball_rs/pkmn/098.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 099     | Wailmer    | ![](https://www.serebii.net/pinball_rs/pkmn/099.gif) | Catch 'Em              | RUBY      | Ocean                     | ![](img/RAGuide/Pinball_Ruby_Ocean.png)                                                       | 3          |
| 100     | Wailord    | ![](https://www.serebii.net/pinball_rs/pkmn/100.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 101     | Numel      | ![](https://www.serebii.net/pinball_rs/pkmn/101.gif) | Catch 'Em              | RUBY      | Volcano                   | ![](img/RAGuide/Pinball_Ruby_Volcano.png)                                                     | 2          |
| 102     | Camerupt   | ![](https://www.serebii.net/pinball_rs/pkmn/102.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 103     | Slugma     | ![](https://www.serebii.net/pinball_rs/pkmn/103.gif) | Catch 'Em              | RUBY      | Volcano                   | ![](img/RAGuide/Pinball_Ruby_Volcano.png)                                                     | 3          |
| 104     | Magcargo   | ![](https://www.serebii.net/pinball_rs/pkmn/104.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 105     | Torkoal    | ![](https://www.serebii.net/pinball_rs/pkmn/105.gif) | Catch 'Em              | RUBY      | Volcano                   | ![](img/RAGuide/Pinball_Ruby_Volcano.png)                                                     | 2          |
| 106     | Grimer     | ![](https://www.serebii.net/pinball_rs/pkmn/106.gif) | Catch 'Em              | ANY       | Cave                      | ![](img/RAGuide/Pinball_Ruby_Cave.png)![](img/RAGuide/Pinball_Sapphire_Cave.png)              | 2          |
| 107     | Muk        | ![](https://www.serebii.net/pinball_rs/pkmn/107.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 108     | Koffing    | ![](https://www.serebii.net/pinball_rs/pkmn/108.gif) | Catch 'Em              | RUBY      | Volcano                   | ![](img/RAGuide/Pinball_Ruby_Volcano.png)                                                     | 2          |
...
| 115     | Skarmory   | ![](https://www.serebii.net/pinball_rs/pkmn/115.gif) | Catch 'Em              | RUBY      | Volcano                   | ![](img/RAGuide/Pinball_Ruby_Volcano.png)                                                     | 3          |
| 116     | Trapinch   | ![](https://www.serebii.net/pinball_rs/pkmn/116.gif) | Hatch                  |           |                           | ![]()                                                                                         |            |
| 117     | Vibrava    | ![](https://www.serebii.net/pinball_rs/pkmn/117.gif) | Catch 'Em or Evolution | SAPPHIRE  | Wilderness                | ![](img/RAGuide/Pinball_Sapphire_Wilderness.png)                                              | 2          |
| 118     | Flygon     | ![](https://www.serebii.net/pinball_rs/pkmn/118.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 119     | Cacnea     | ![](https://www.serebii.net/pinball_rs/pkmn/119.gif) | Catch 'Em              | SAPPHIRE  | Wilderness                | ![](img/RAGuide/Pinball_Sapphire_Wilderness.png)                                              | 2          |
| 120     | Cacturne   | ![](https://www.serebii.net/pinball_rs/pkmn/120.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 121     | Swablu     | ![](https://www.serebii.net/pinball_rs/pkmn/121.gif) | Catch 'Em              | SAPPHIRE  | Wilderness                | ![](img/RAGuide/Pinball_Sapphire_Wilderness.png)                                              | 3          |
| 122     | Altaria    | ![](https://www.serebii.net/pinball_rs/pkmn/122.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 123     | Zangoose   | ![](https://www.serebii.net/pinball_rs/pkmn/123.gif) | Catch 'Em              | RUBY      | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)                                                      | 3          |
| 124     | Seviper    | ![](https://www.serebii.net/pinball_rs/pkmn/124.gif) | Catch 'Em              | SAPPHIRE  | Plains                    | ![](img/RAGuide/Pinball_Sapphire_Plains.png)                                                  | 3          |
| 125     | Lunatone   | ![](https://www.serebii.net/pinball_rs/pkmn/125.gif) | Catch 'Em              | SAPPHIRE  | Cave                      | ![](img/RAGuide/Pinball_Sapphire_Cave.png)                                                    | 2          |
| 126     | Solrock    | ![](https://www.serebii.net/pinball_rs/pkmn/126.gif) | Catch 'Em              | RUBY      | Cave                      | ![](img/RAGuide/Pinball_Ruby_Cave.png)                                                        | 2          |
| 127     | Barboach   | ![](https://www.serebii.net/pinball_rs/pkmn/127.gif) | Catch 'Em              | SAPPHIRE  | Lake                      | ![](img/RAGuide/Pinball_Sapphire_Lake.png)                                                    | 2          |
| 128     | Whiscash   | ![](https://www.serebii.net/pinball_rs/pkmn/128.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 129     | Corphish   | ![](https://www.serebii.net/pinball_rs/pkmn/129.gif) | Catch 'Em              | SAPPHIRE  | Lake                      | ![](img/RAGuide/Pinball_Sapphire_Lake.png)                                                    | 2          |
| 130     | Crawdaunt  | ![](https://www.serebii.net/pinball_rs/pkmn/130.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 131     | Baltoy     | ![](https://www.serebii.net/pinball_rs/pkmn/131.gif) | Catch 'Em              | SAPPHIRE  | Wilderness                | ![](img/RAGuide/Pinball_Sapphire_Wilderness.png)                                              | 2          |
| 132     | Claydol    | ![](https://www.serebii.net/pinball_rs/pkmn/132.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 133     | Lileep     | ![](https://www.serebii.net/pinball_rs/pkmn/133.gif) | Catch 'Em              | RUBY      | Ocean                     | ![](img/RAGuide/Pinball_Ruby_Ocean.png)                                                       | 3          |
| 134     | Cradily    | ![](https://www.serebii.net/pinball_rs/pkmn/134.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 135     | Anorith    | ![](https://www.serebii.net/pinball_rs/pkmn/135.gif) | Catch 'Em              | SAPPHIRE  | Ocean                     | ![](img/RAGuide/Pinball_Sapphire_Ocean.png)                                                   | 3          |
...
| 138     | Jigglypuff | ![](https://www.serebii.net/pinball_rs/pkmn/138.gif) | Catch 'Em or EVO       | ANY       | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)![](img/RAGuide/Pinball_Sapphire_Plains.png)          | 2          |
| 139     | Wigglytuff | ![](https://www.serebii.net/pinball_rs/pkmn/139.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 140     | Feebas     | ![](https://www.serebii.net/pinball_rs/pkmn/140.gif) | Catch 'Em              | SAPPHIRE  | Lake                      | ![](img/RAGuide/Pinball_Sapphire_Lake.png)                                                    | 2          |
| 141     | Milotic    | ![](https://www.serebii.net/pinball_rs/pkmn/141.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 142     | Castform   | ![](https://www.serebii.net/pinball_rs/pkmn/142.gif) | Catch 'Em              | ANY       | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)![](img/RAGuide/Pinball_Sapphire_Plains.png)          | 3          |
| 143     | Staryu     | ![](https://www.serebii.net/pinball_rs/pkmn/143.gif) | Catch 'Em              | RUBY      | Ocean                     | ![](img/RAGuide/Pinball_Ruby_Ocean.png)                                                       | 3          |
| 144     | Starmie    | ![](https://www.serebii.net/pinball_rs/pkmn/144.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 145     | Kecleon    | ![](https://www.serebii.net/pinball_rs/pkmn/145.gif) | Catch 'Em              | ANY       | Plains                    | ![](img/RAGuide/Pinball_Ruby_Plains.png)![](img/RAGuide/Pinball_Sapphire_Plains.png)          | 3          |
...
| 148     | Duskull    | ![](https://www.serebii.net/pinball_rs/pkmn/148.gif) | Catch 'Em              | ANY       | Forest                    | ![](img/RAGuide/Pinball_Ruby_Forest.png)![](img/RAGuide/Pinball_Sapphire_Forest.png)          | 2          |
| 149     | Dusclops   | ![](https://www.serebii.net/pinball_rs/pkmn/149.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 150     | Tropius    | ![](https://www.serebii.net/pinball_rs/pkmn/150.gif) | Catch 'Em              | SAPPHIRE  | Forest                    | ![](img/RAGuide/Pinball_Sapphire_Forest.png)                                                  | 3          |
| 151     | Chimecho   | ![](https://www.serebii.net/pinball_rs/pkmn/151.gif) | Hatch                  |           |                           | ![]()                                                                                         |            |
| 152     | Absol      | ![](https://www.serebii.net/pinball_rs/pkmn/152.gif) | Catch 'Em              | SAPPHIRE  | Wilderness                | ![](img/RAGuide/Pinball_Sapphire_Wilderness.png)                                              | 2          |
| 153     | Vulpix     | ![](https://www.serebii.net/pinball_rs/pkmn/153.gif) | Catch 'Em              | RUBY      | Volcano                   | ![](img/RAGuide/Pinball_Ruby_Volcano.png)                                                     | 2          |
...
| 156     | Pikachu    | ![](https://www.serebii.net/pinball_rs/pkmn/156.gif) | Catch 'Em or Evolution | RUBY      | Safari Zone               | ![](img/RAGuide/Pinball_Ruby_Safari_Zone.png)                                                 | 3          |
| 157     | Raichu     | ![](https://www.serebii.net/pinball_rs/pkmn/157.gif) | Evolution              |           |                           | ![]()                                                                                         |            |
| 158     | Psyduck    | ![](https://www.serebii.net/pinball_rs/pkmn/158.gif) | Catch 'Em              | RUBY      | Safari Zone               | ![](img/RAGuide/Pinball_Ruby_Safari_Zone.png)                                                 | 2          |
...
| 161     | Wobbuffet  | ![](https://www.serebii.net/pinball_rs/pkmn/161.gif) | Catch 'Em or Evolution | RUBY      | Safari Zone               | ![](img/RAGuide/Pinball_Ruby_Safari_Zone.png)                                                 | 3          |
...
| 164     | Girafarig  | ![](https://www.serebii.net/pinball_rs/pkmn/164.gif) | Catch 'Em              | RUBY      | Safari Zone               | ![](img/RAGuide/Pinball_Ruby_Safari_Zone.png)                                                 | 3          |
...
| 167     | Pinsir     | ![](https://www.serebii.net/pinball_rs/pkmn/167.gif) | Catch 'Em              | RUBY      | Safari Zone               | ![](img/RAGuide/Pinball_Ruby_Safari_Zone.png)                                                 | 2          |
| 168     | Heracross  | ![](https://www.serebii.net/pinball_rs/pkmn/168.gif) | Catch 'Em              | RUBY      | Safari Zone               | ![](img/RAGuide/Pinball_Ruby_Safari_Zone.png)                                                 | 2          |
| 169     | Rhyhorn    | ![](https://www.serebii.net/pinball_rs/pkmn/169.gif) | Catch 'Em              | RUBY      | Safari Zone               | ![](img/RAGuide/Pinball_Ruby_Safari_Zone.png)                                                 | 2          |
...
| 176     | Clamperl   | ![](https://www.serebii.net/pinball_rs/pkmn/176.gif) | Catch 'Em              | SAPPHIRE  | Ocean                     | ![](img/RAGuide/Pinball_Sapphire_Ocean.png)                                                   | 3          |
...
| 179     | Relicanth  | ![](https://www.serebii.net/pinball_rs/pkmn/179.gif) | Catch 'Em              | ANY       | Ocean                     | ![](img/RAGuide/Pinball_Ruby_Ocean.png)![](img/RAGuide/Pinball_Sapphire_Ocean.png)            | 3          |
...
| 183     | Luvdisc    | ![](https://www.serebii.net/pinball_rs/pkmn/183.gif) | Catch 'Em              | ANY       | Ocean                     | ![](img/RAGuide/Pinball_Ruby_Ocean.png)![](img/RAGuide/Pinball_Sapphire_Ocean.png)            | 2          |
...
| 188     | Shelgon    | ![](https://www.serebii.net/pinball_rs/pkmn/188.gif) | Catch 'Em or Evolution | ANY       | Cave                      | ![](img/RAGuide/Pinball_Ruby_Cave.png)![](img/RAGuide/Pinball_Sapphire_Cave.png)              | 2          |
