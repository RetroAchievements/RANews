...
| 3DO Interactive Multiplayer | {% rauserpic Vyach59 %}                                                                                                                     | 9              | <!-- 43  --> |
| Amstrad CPC                 | {% rauserpic roukanumachi %}                                                                                                                | 15             | <!-- 37  --> |
| Apple II                    | {% rauserpic guineu %}                                                                                                                      | 12             | <!-- 38  --> |
| Arcade                      | {% rauserpic dcmpinguin%}                                                                                                                   | 69             | <!-- 27  --> |
...
| Fairchild Channel F         | {% rauserpic alphacrust %} & {% rauserpic guineu %}                                                                                         | 19             | <!-- 57  --> |
...
| Homebrew Champ              | {% rauserpic AuburnRDM %}                                                                                                                   | 168            | <!--     --> |
| Intellivision               | {% rauserpic Jungon %}                                                                                                                      | 14             | <!-- 45  --> |
| Magnavox Odyssey 2          | {% rauserpic Jungon %}                                                                                                                      | 8              | <!-- 23  --> |
| Master System               | {% rauserpic Jungon %}                                                                                                                      | 75             | <!-- 11  --> |
| Mega Drive                  | {% rauserpic DUT %}                                                                                                                         | 119            | <!-- 1   --> |
| Mega Duck                   | {% rauserpic AzuchiAkeshi %}, {% rauserpic Infernum %}, {% rauserpic Jaeger42 %}, {% rauserpic soltyd %} & {% rauserpic TheRealBillHicks %} | 4              | <!-- 69  --> |
| MSX                         | {% rauserpic guineu %}                                                                                                                      | 9              | <!-- 29  --> |
| Nintendo 64                 | {% rauserpic BenTobitt %}                                                                                                                   | 45             | <!-- 2   --> |
| Neo Geo Pocket              | {% rauserpic MelodyAsh %}                                                                                                                   | 8              | <!-- 14  --> |
| NES                         | {% rauserpic SanMarino %}                                                                                                                   | 242            | <!-- 7   --> |
...
| PlayStation                 | {% rauserpic FBiDev %}                                                                                                                      | 82             | <!-- 12  --> |
