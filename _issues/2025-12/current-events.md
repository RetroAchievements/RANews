...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>1,347 users are tied in first with 2 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>16 users are currently tied in first place with 207 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic WanderingHeiho %} - 163 Points </li>
                    <li value="2">{% rauserpic TanteiRotana %} - 154 Points </li>
                    <li value="2">{% rauserpicalt ThatWhiteBat, Sylrifaide %} - 154 Points </li>
                    <li value="4">{% rauserpic Pikapals %} - 153 Points </li>
                    <li value="4">{% rauserpic Greyfalken %} - 153 Points </li>
                    <li value="6">{% rauserpic Sutarion %} - 152 Points </li>
                    <li value="6">{% rauserpic Akai %} - 152 Points </li>
                    <li value="6">{% rauserpic Tyrota %} - 152 Points </li>
                    <li value="9">{% rauserpic HungryWalnut %} - 151 Points </li>
                    <li value="10">{% rauserpic WeerDough %} - 150 Points </li>
                </ol>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic Verros %} - 73 Points</li>
                    <li value="2">{% rauserpic DeeCee %} - 52 Points</li>
                    <li value="3">{% rauserpic Kaiserlucas %} - 50 Points</li>
                    <li value="4">{% rauserpic MeloDeathAtmoBlack %} - 47 Points</li>
                    <li value="5">{% rauserpicalt GenesisRA, genesislover %} - 46 Points</li>
                    <li value="6">{% rauserpic Daroachie %} - 42 Points</li>
                    <li value="7">{% rauserpic s0uth %} - 40 Points</li>
                    <li value="8">{% rauserpic PepeJohn %} - 36 Points</li>
                    <li value="9">{% rauserpic SushiSeijin %} - 35 Points</li>
                    <li value="10">{% rauserpicalt Kexin, Nintagious %} - 33 Points</li>
                    <li value="10">{% rauserpic jhonen124 %} - 33 Points</li>
                </ol>
            </td>
        </tr>
    </tbody>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>65 players have earned the PlayJam Vol. 1 badge.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
                ...
                <table>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td colspan=2>{% ragamepic 22877, 075750, Dog of Bay %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic Ezezin %}</td>
                            <td colspan=2>{% ragamepic 1076, 120322, Olympic Summer Games %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic Molson %}</td>
                            <td colspan=2>{% ragamepic 18025, 115161, Disney Sports: Basketball %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic Splasher %}</td>
                            <td colspan=2>{% ragamepic 18025, 115161, Disney Sports: Basketball %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic Trisscorp %}</td>
                            <td colspan=2>{% ragamepic 18724, 071354, Downstream Panic! | Aqua Panic! %}</td>
                        </tr>
                    </tbody>
                </table>
                <br>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic NEOMAR %}<sup>**</sup> - 1463 Points</li>
                    <li value="2">{% rauserpic Lonoke31 %}<sup>**</sup> - 1380 Points</li>
                    <li value="3">{% rauserpic Sutarion %}<sup>**</sup> - 1171 Points</li>
                    <li value="4">{% rauserpic Timmay %}<sup>**</sup> - 1161 Points</li>
                    <li value="5">{% rauserpicalt AmirGaris, Amir96lx %}<sup>**</sup> - 1102 Points</li>
                    <li value="6">{% rauserpic MiningMario %}<sup>**</sup> - 1069 Points</li>
                    <li value="7">{% rauserpic NeoRetroGamer %}<sup>**</sup> - 729 Points</li>
