...
| Arcade                      | {% rauserpic dcmpinguin%}                                                      | 75             | <!-- 27  --> |
...
| Game Boy Advance            | {% rauserpic bonecrusher1022 %}                                                | 117            | <!-- 5   --> |
| Game Boy Color              | {% rauserpic pitapocket17 %}                                                   | 59             | <!-- 6   --> |
| Game Gear                   | {% rauserpic Nydaxn %}                                                         | 65             | <!-- 15  --> |
| Hack Champ                  | {% rauserpic HolyShinx %}                                                      | 204            | <!--     --> |
| Homebrew Champ              | {% rauserpic AuburnRDM %}                                                      | 182            | <!--     --> |
| Intellivision               | {% rauserpic Jungon %}                                                         | 14             | <!-- 45  --> |
| Magnavox Odyssey 2          | {% rauserpic Jungon %}                                                         | 8              | <!-- 23  --> |
| Master System               | {% rauserpic Jungon %}                                                         | 79             | <!-- 11  --> |
| Mega Drive                  | {% rauserpic DUT %}                                                            | 126            | <!-- 1   --> |
...
| PC Engine                   | {% rauserpic Infernum %}                                                       | 33             | <!-- 8   --> |
...
| PlayStation 2               | {% rauserpic Infernum %}                                                       | 24             | <!-- 21  --> |
...
| Virtual Boy                 | {% rauserpic guineu %}                                                         | 12             | <!-- 28  --> |
