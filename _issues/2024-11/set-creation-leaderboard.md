...
| Rank | Developer                       | Sets Created |
| ---- | ------------------------------- | ------------ |
| 1    | {% rauserpic AlexGatao %}       | 10           |
| 2    | {% rauserpic timenoe %}         | 7            |
| 3    | {% rauserpic Blazekickn %}      | 6            |
| 3    | {% rauserpic WilHiteWarrior %}  | 6            |
| 5    | {% rauserpic Gollawiz %}        | 5            |
| 5    | {% rauserpic TheMysticalOne %}  | 5            |
| 7    | {% rauserpic Layton %}          | 4            |
| 7    | {% rauserpic LiveFastCyYoung %} | 4            |
| 7    | {% rauserpic Snow %}            | 4            |
| 10   | {% rauserpic blendedsea %}      | 3            |
| 10   | {% rauserpic Bryan1150 %}       | 3            |
| 10   | {% rauserpic Delmaru %}         | 3            |
| 10   | {% rauserpic MGNS8M %}          | 3            |
| 10   | {% rauserpic Sines %}           | 3            |
...
| 4    | {% rauserpic TeddyWestside %}  | 21           |
| 5    | {% rauserpic timenoe %}        | 19           |
| 6    | {% rauserpic AlexGatao %}      | 18           |
| 7    | {% rauserpic WilHiteWarrior %} | 17           |
| 8    | {% rauserpic blendedsea %}     | 16           |
| 8    | {% rauserpic Gollawiz %}       | 16           |
| 8    | {% rauserpic pinguupinguu %}   | 16           |
...
| 10   | {% rauserpic ThatAmericanSlacker %} | 6            |
...
| 5    | {% rauserpic SuperMeatBro %}    | 23           |
| 6    | {% rauserpic Bl4h8L4hBl4h %}    | 20           |
| 6    | {% rauserpic GalacticSpear %}   | 20           |
| 8    | {% rauserpic Dexterspet %}      | 19           |
| 9    | {% rauserpic EulerMoises1981 %} | 18           |
| 10   | {% rauserpic andreemendess %}   | 16           |
