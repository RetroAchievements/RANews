...
|      | {% ragamepic 12227, 120684, Ring of Destruction: Slam Masters II \| Super Muscle Bomber %} | {% rauserpic jonzay %}             | {% rauserpic CySlaytor %}        | 2/5/2026     |
...
| ⭐    | {% ragamepic 16220, 124266, River King: Mystic Valley %}                                   | {% rauserpic Streetbackguy %}      | {% rauserpic cdpowe %}           | 2/15/2026    |
|      | {% ragamepic 24969, 124492, Monsters vs. Aliens %}                                         | {% rauserpic BEXUS %}              | {% rauserpic BigDonRob %}        | 2/15/2026    |
|      | {% ragamepic 13139, 121234, The Official Frogger %}                                        | {% rauserpic RickAlbuquerque %}    | {% rauserpic Pilzkopf %}         | 2/15/2026    |
|      | {% ragamepic 36319, 120967, Q*bert %}                                                      | {% rauserpic GrungierWall7 %}      | {% rauserpic Pilzkopf %}         | 2/21/2026    |
|      | {% ragamepic 14425, 121405, Dragon Ball Z Gaiden: Saiya Jin Zetsumetsu Keikaku %}          | {% rauserpic jhonen124 %}          | {% rauserpic Yanbetari %}        | 2/22/2026    |
|      | {% ragamepic 10795, 121508, Iggy's Reckin' Balls %}                                        | {% rauserpic GravyGray %}          | {% rauserpic Pilzkopf %}         | 2/27/2026    |
|      | {% ragamepic 20360, 121758, TOCA: Touring Car Championship %}                              | {% rauserpic kasapluie %}          | {% rauserpic TheXIIIthX %}       | 2/28/2026    |
...
| Reviews In Progress             | 25  |
| Jr. Developers Promoted         | 6   |
| Jr. Developers Promoted in 2026 | 6   |
| Active Jr. Developers           | 112 |

<br>

| Reviewer                         | Sets Reviewed |
| -------------------------------- | ------------- |
| {% rauserpic CySlaytor %}        | 8             |
| {% rauserpic Pilzkopf %}         | 5             |
| {% rauserpic TheXIIIthX %}       | 3             |
