...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>105 users are tied in first with 18 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic WanderingHeiho %} - 37 Points</li>
                    <li value="2">{% rauserpic Foxkazm %} - 31 Points</li>
                    <li value="2">{% rauserpic Poolsharker %} - 31 Points</li>
                    ...
                    <li value="5">{% rauserpic rileythepegasus %} - 30 Points</li>
                </ol>
            </td>
        </tr>
    </tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    ...
                    <li value="3">{% rauserpic MeloDeathAtmoBlack %} - 62 Points</li>
                    <li value="4">{% rauserpic DeeCee %} - 60 Points</li>
...
<table>
    <tbody>
        ...
        <tr>
            <td>{% raeventpic 203, 124758, Pixelheart RAve: Retro Dating Adventure [TRACKING] %}</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <ol>
                    ...
                    <li value="6">{% rauserpic HungryWalnut %} - 27 Points</li>
                    <li value="6">{% rauserpic Sutarion %} - 27 Points</li>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>2 players are tied in first with 7 gym clears and 23 players are tied in third with 6 gym clears.<br><br>Check out the <a href="https://docs.google.com/spreadsheets/d/1xIAZcS4rgX9kkRG2Ixk4fgFteBxubObv4EuZB57ICuU/edit?gid=0#gid=0">scoring sheet</a> for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Event Information:</strong></td>
            <td><a href="https://retroachievements.org/forums/topic/32796">https://retroachievements.org/forums/topic/32796</a></td>
        </tr>
        <tr>
            <td><strong>Duration:</strong></td>
            <td>Season 8: 10/13/25-01/31/26</td>
        </tr>
        <tr>
            <td><strong>Host(s):</strong></td>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>86 players have earned the PlayJam Vol. 1 badge.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
            ...
            <td>Month 68 Results<br><br>
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan=2>{% ragamepic 14450, 063632, ~Hack~ Resident Evil 3: Dark Infection %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic Enagonius %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>{% rauserpic Ghosty %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                            <td rowspan=2>{% rauserpic Hombreton %}</td>
                            <td colspan=2>{% ragamepic 16923, 121447, Zool 2 %}</td>
                        </tr>
                        <tr>
                            <td colspan=2>{% ragamepic 14546, 042724, Shinobi Legions %}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>{% rauserpic L1GHTNING %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic Lonoke31 %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic mx01 %}</td>
                            <td colspan=2>{% ragamepic 2043, 013166, Toxic Crusaders %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic Nokashi %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>{% rauserpicalt haavi, Prota %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>{% rauserpic Realzameer %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic rholliday %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic SkamSoso %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                            <td>{% rauserpic smallfryal %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td>{% rauserpic WheelsAndWhirls %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                            <td rowspan=2>{% rauserpic Xymjak %}</td>
                            <td colspan=2>{% ragamepic 16923, 121447, Zool 2 %}</td>
                        </tr>
                        <tr>
                            <td colspan=2>{% ragamepic 14546, 042724, Shinobi Legions %}</td>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic NEOMAR %}<sup>**</sup> - 1551 Points</li>
                    <li value="2">{% rauserpic Lonoke31 %}<sup>**</sup> - 1468 Points</li>
                    <li value="3">{% rauserpic Sutarion %}<sup>**</sup> - 1259 Points</li>
                    <li value="4">{% rauserpic Timmay %}<sup>**</sup> - 11249 Points</li>
                    <li value="5">{% rauserpicalt AmirGaris, Amir96lx %}<sup>**</sup> - 1189 Points</li>
                    <li value="6">{% rauserpic MiningMario %}<sup>**</sup> - 1157 Points</li>
                    ...
                    <li value="10">{% rauserpic CMinusMinus %} - 518 Points</li>
                </ol>
            ...
            <td>
                ...
                <tr>
                    <td style="vertical-align: top;">
                        <ol>
                            <li value="1" >{% rauserpic Pikur %} - 36 Points</li>
                            <li value="2" >{% rauserpic Molson %} - 28 Points</li>
                            <li value="3" >{% rauserpic Kikingkikker %} - 22 Points</li>
                            <li value="4" >{% rauserpic WARABIMON %} - 21 Points</li>
                            <li value="5" >{% rauserpic Bartis1989 %} - 20 Points</li>
                            <li value="6" >{% rauserpic Whynot15 %} - 19 Points</li>
                            <li value="6" >{% rauserpic HungryWalnut %} - 19 Points</li>
                            <li value="8" >{% rauserpic Aeliana %} - 18 Points</li>
                            <li value="8" >{% rauserpic Foolacetic %} - 18 Points</li>
                            <li value="10" >{% rauserpic Aikner %} - 15 Points</li>
                        </ol>
                    </td>
                </tr>
                </tbody>
