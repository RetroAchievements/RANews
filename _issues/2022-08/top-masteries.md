...
| 3DO Interactive Multiplayer | {% rauserpic AuburnRDM %}                                                   | 6              | <!-- 43  --> |
| Amstrad CPC                 | {% rauserpic roukanumachi %}                                                | 14             | <!-- 37  --> |
| Apple II                    | {% rauserpic guineu %}                                                      | 12             | <!-- 38  --> |
| Arcade                      | {% rauserpic Wendigo %} & {% rauserpic dcmpinguin%}                         | 56             | <!-- 27  --> |
| Arduboy                     | {% rauserpic bennz13 %}                                                     | 28             | <!-- 71  --> |
...
| ColecoVision                | {% rauserpic PMniac %}                                                      | 9              | <!-- 44  --> |
| Dreamcast                   | {% rauserpic SteveHarvey %}                                                 | 19             | <!-- 40  --> |
| Events                      | {% rauserpic televandalist %}                                               | 28             | <!-- 101 --> |
| Fairchild Channel F         | {% rauserpic AuburnRDM %}                                                   | 17             | <!-- 57  --> |
| Game Boy                    | {% rauserpic Shootzy %}                                                     | 124            | <!-- 4   --> |
| Game Boy Advance            | {% rauserpic bonecrusher1022 %}                                             | 108            | <!-- 5   --> |
| Game Boy Color              | {% rauserpic pitapocket17 %}                                                | 56             | <!-- 6   --> |
| Game Gear                   | {% rauserpic Nydaxn %}                                                      | 62             | <!-- 15  --> |
| Hack Champ                  | {% rauserpic HolyShinx %}                                                   | 196            | <!--     --> |
| Homebrew Champ              | {% rauserpic AuburnRDM %}                                                   | 163            | <!--     --> |
| Intellivision               | {% rauserpic Jungon %} & {% rauserpic guineu %}                             | 13             | <!-- 45  --> |
| Magnavox Odyssey 2          | {% rauserpic alphacrust %} & {% rauserpic Jungon %}                         | 6              | <!-- 23  --> |
| Master System               | {% rauserpic Jungon %}                                                      | 72             | <!-- 11  --> |
| Mega Drive                  | {% rauserpic DUT %}                                                         | 119            | <!-- 1   --> |
| Mega Duck                   | {% rauserpic Infernum %}, {% rauserpic Jaeger42 %} & {% rauserpic soltyd %} | 4              | <!-- 69  --> |
| MSX                         | {% rauserpic guineu %}                                                      | 8              | <!-- 29  --> |
| Nintendo 64                 | {% rauserpic BenTobitt %}                                                   | 45             | <!-- 2   --> |
| Neo Geo Pocket              | {% rauserpic MelodyAsh %}                                                   | 7              | <!-- 14  --> |
| NES                         | {% rauserpic SanMarino %}                                                   | 240            | <!-- 7   --> |
| Nintendo DS                 | {% rauserpic Olafur %}                                                      | 67             | <!-- 18  --> |
| PC Engine                   | {% rauserpic Infernum %}                                                    | 38             | <!-- 8   --> |
| PC-8000/8800                | {% rauserpic guineu %}                                                      | 10             | <!-- 47  --> |
| PC-FX                       | {% rauserpic Annonith %} & {% rauserpic YahwehTzVaoth %}                    | 4              | <!-- 49  --> |
| PlayStation                 | {% rauserpic Andrey199650 %}                                                | 76             | <!-- 12  --> |
| PlayStation Portable        | {% rauserpic minibt %}                                                      | 34             | <!-- 41  --> |
...
| SNES                        | {% rauserpic danibodom %}                                                   | 195            | <!-- 3   --> |
| Vectrex                     | {% rauserpic Jungon %}                                                      | 8              | <!-- 46  --> |
