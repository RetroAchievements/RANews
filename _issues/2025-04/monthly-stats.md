...
| Number of sets released.                                         | 142        | <!-- Get from Hot Cheevs -->
| Number of achievements released.                                 | 3,938      | <!-- 01 -->
| Number of hardcore achievements earned.                          | 2,446,727  | <!-- 02 -->
| Number of code notes created.                                    | 18,442     | <!-- 03 -->
| Number of mastery awards awarded.                                | 22,939     | <!-- 04 -->
| Number of beaten awards awarded.                                 | 41,444     | <!-- 04B -->
| Number of set requests made.                                     | 6,736      | <!-- 05 -->
| Number of leaderboards created.                                  | 1,133      | <!-- 06 -->
| Number of leaderboard entries submitted.                         | 495,967    | <!-- 07 -->
| Number of users who have earned at least 1 hardcore achievement. | 41,409     | <!-- 08 -->
| Number of total hardcore points earned by players.               | 15,934,613 | <!-- 09 -->
| Number of total hardcore retro points earned by players.         | 64,966,428 | <!-- 09 -->
| Number of user accounts created.                                 | 36,476     | <!-- 10 -->
| Number of new user accounts reaching ranked status.              | 667        | <!-- 10 -->
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Unlocks</th></tr></thead><tbody>
        ...
        <tr><td>WASM-4                      </td><td> 3,492 </td></tr>
...
| Rank | Achievement                                                   | Game                                                                               | Times Awarded |
| :--- | :------------------------------------------------------------ | :--------------------------------------------------------------------------------- | :------------ |
| 1    | {% raachpic 490276, 315508, League Champion %}                | {% ragamepic 32718, 106174, Achievement of the Week 2025 %}                        | 850           |
| 2    | {% raachpic 502624, 570107, First Step to Victory %}          | {% ragamepic 30894, 101849, ~Hack~ Pokemon Emerald Seaglass %}                     | 488           |
| 3    | {% raachpic 495195, 19419, Level 1 complete %}                | {% ragamepic 32847, 107626, RA Roulette 2025 %}                                    | 435           |
| 4    | {% raachpic 508573, 576136, Spot IV %}                        | {% ragamepic 33104, 109864, Find the Pixel 2025 %}                                 | 329           |
| 5    | {% raachpic 495769, 561113, Timber!! %}                       | {% ragamepic 32909, 107179, Terraria %}                                            | 252           |
| 6    | {% raachpic 494260, 46760, Bowser Disposer %}                 | {% ragamepic 32838, 106787, RA Roulette 2024 - Evergreen %}                        | 225           |
| 7    | {% raachpic 493747, 129308, Bug Catcher %}                    | {% ragamepic 32836, 106779, RA Roulette 2023 - Evergreen %}                        | 212           |
| 8    | {% raachpic 496090, 564777, Trade Offer %}                    | {% ragamepic 32910, 107695, Terraria [Subset - Completionist] %}                   | 156           |
| 9    | {% raachpic 504619, 571857, The Wheels on the Bus %}          | {% ragamepic 23777, 108861, Kemono Patrol %}                                       | 127           |
| 10   | {% raachpic 504174, 571712, I got you, Little Buddy %}        | {% ragamepic 7333, 109231, ~Prototype~ Sonic Crackers %}                           | 109           |
| 11   | {% raachpic 496585, 563858, Shield of Cthulhu %}              | {% ragamepic 32911, 107700, Terraria [Subset - World Modes & Seeds] %}             | 106           |
| 12   | {% raachpic 496379, 561373, Hey Tails! %}                     | {% ragamepic 6333, 103041, Sonic Adventure DX %}                                   | 102           |
| 13   | {% raachpic 504636, 571902, Hopped to the End %}              | {% ragamepic 33058, 108850, Frog Jump: Ordering Numbers %}                         | 98            |
| 14   | {% raachpic 498150, 563775, Chop 'Til You Drop %}             | {% ragamepic 32929, 107699, Terraria [Subset - Player Difficulties] %}             | 97            |
| 15   | {% raachpic 499619, 566824, Cucco Crazy %}                    | {% ragamepic 2198, 103269, The Legend of Zelda: Collector's Edition %}             | 96            |
| 16   | {% raachpic 493225, 321970, Poor Plumber %}                   | {% ragamepic 32831, 106777, Achievement of the Week 2014 - Evergreen %}            | 95            |
| 17   | {% raachpic 502508, 569915, Quest for Masters %}              | {% ragamepic 11202, 048069, The Legend of Zelda: Ocarina of Time - Master Quest %} | 88            |
| 18   | {% raachpic 502509, 569916, Bad Driver %}                     | {% ragamepic 3808, 109876, Super Off Road %}                                       | 86            |
| 19   | {% raachpic 495115, 566363, A Leafy Start %}                  | {% ragamepic 557, 044234, Sonic Advance 2 %}                                       | 83            |
| 20   | {% raachpic 493429, 46583, Special Sorta Person %}            | {% ragamepic 32833, 106758, Achievement of the Week 2016 - Evergreen %}            | 81            |
| 21   | {% raachpic 505419, 572675, 75 Years of F1 RAcing - Driver %} | {% ragamepic 33092, 109255, 75 Years of F1 RAcing %}                               | 81            |
| 22   | {% raachpic 503334, 571002, When Robots Awakened %}           | {% ragamepic 26911, 108979, ~Homebrew~ Wall-E %}                                   | 76            |
| 23   | {% raachpic 500441, 566980, Fastest Lap %}                    | {% ragamepic 20731, 108492, FlatOut 2 %}                                           | 72            |
| 24   | {% raachpic 498756, 565463, A Little Unfair... For Them %}    | {% ragamepic 9602, 081455, Super Smash Bros. Melee %}                              | 71            |
| 25   | {% raachpic 493950, 559286, The Alley %}                      | {% ragamepic 20764, 077696, The Godfather: The Game %}                             | 68            |
...
<div>
    ...
    <table><thead><tr><th>Console</th><th>Awards</th></tr></thead><tbody>
        ...
        <tr><td>Watara Supervision          </td><td> 48 </td></tr>
...
| Number of tickets created.                     | 1,520 | <!-- A -->
| Number of tickets triggered at the wrong time. | 347   | <!-- B -->
| Number of tickets did not trigger.             | 1,173 | <!-- C -->
| Number of tickets resolved.                    | 775   | <!-- D -->
| Number of tickets closed.                      | 635   | <!-- E -->
