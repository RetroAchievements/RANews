...
<div class="section-link">
    <a href="./rapodcast.html">
        <div class="section-content">
            ...
            <p>Join the RetroAchievements community and listen to the latest RAPodcast. This months podcast has our host, TimeCrush, featuring Sarconius, the new #1 ranked player on the site. Listen along as they discuss the journey to the top of the hill and updates since their last episode.</p>
        </div>
    </a>
</div>
<div class="section-link">
...
<div class="section-link">
    <a href="./raguide.html">
        <div class="section-content">
            ...
            <p>Master the legendary adventure with the latests RAGuide for Final Fantasy VII. Join Cloud and his allies as they battle against Shinra and Sephiroth in a world on the verge of ruin. Master powerful materia, conquer challenges, and experience every iconic moment of this timeless RPG classic.</p>
        </div>
    </a>
</div>
<div class="section-link">
...
<div class="section-link">
    <a href="./spot-the-difference.html">
        <div class="section-content">
            ...
            <p>In this section, we challenge readers to put their observation skills to the test with a Spot the Difference game created by SporyTike for the game Pokémon Mystery Dungeon: Explorers of Sky. There are 10 differences to find, and readers who spot them all will be featured in the next issue. So sharpen your eyes and get ready for some fun!</p>
        </div>
    </a>
</div>
<div class="section-link">
...
<div class="section-link">
    <div class="section-content">
        ...
        <table><tbody>
            <tr>
                <td>{% rauserpic  bdjeffyp %}</td>
                <td>{% rauserpic alturds %}</td>
            ...
            <tr>
                ...
                <td>{% rauserpicalt lLorak, Balou2k12 %}</td>
            </tr>
            <tr>
                <td>{% rauserpic MiguelsoaresGames2 %}</td>
                <td>{% rauserpic moosemoosemoose %}</td>
            ...
            <tr>
                ...
                <td>{% rauserpic OldSport %}</td>
            </tr>
            <tr>
                <td>{% rauserpic pinguupinguu %}</td>
                <td>{% rauserpic PlugMeister %}</td>
                <td>{% rauserpic psychosailor1119 %}</td>
            </tr>
            <tr>
            ...
            <tr>
                <td>{% rauserpicalt SuperRAGamer18, SuperGamer18 %}</td>
                <td>{% rauserpic Sutarion %}</td>
                <td>{% rauserpic talosparoxi %}</td>
            </tr>
            <tr>
