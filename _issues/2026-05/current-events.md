...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>134 users are tied in first with 29 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1" >{% rauserpic WanderingHeiho %} - 68 Points</li>
                    <li value="2" >{% rauserpic Foxkazm %} - 59 Points</li>
                    <li value="2" >{% rauserpic Tyrota %} - 59 Points</li>
                    <li value="2" >{% rauserpic Skarm137 %} - 59 Points</li>
                    <li value="2" >{% rauserpic ZTZT %} - 59 Points</li>
                    <li value="2" >{% rauserpic PsyXchO %} - 59 Points</li>
                    <li value="2" >{% rauserpic LeeD %} - 59 Points</li>
                    <li value="2" >{% rauserpic Poolsharker %} - 59 Points</li>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic Verros %} - 87 Points</li>
                    <li value="2">{% rauserpic Kaiserlucas %} - 66 Points</li>
                    <li value="3">{% rauserpic MeloDeathAtmoBlack %} - 64 Points</li>
                    <li value="4">{% rauserpic s0uth %} - 62 Points</li>
                    <li value="5">{% rauserpic DeeCee %} - 60 Points</li>
                    <li value="6">{% rauserpic PepeJohn %} - 58 Points</li>
                    <li value="7">{% rauserpic Daroachie %} - 55 Points</li>
                    <li value="8">{% rauserpicalt Kexin, Nintagious %} - 53 Points</li>
                    <li value="9">{% rauserpicalt GenesisRA, genesislover %} - 47 Points</li>
                    <li value="10">{% rauserpic SushiSeijin %} - 41 Points</li>
                </ol>
                <br>Check out the game page for the up to date rankings.
            </td>
        </tr>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>5 players are tied in first with 9 gym clears and 14 players are tied in sixth with 8 gym clears.<br><br>Check out the <a href="https://docs.google.com/spreadsheets/d/1xIAZcS4rgX9kkRG2Ixk4fgFteBxubObv4EuZB57ICuU/edit?gid=0#gid=0">scoring sheet</a> for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>20 players have earned the DevJam Vol. 1 badge.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
        ...
        <tr>
            ...
            <td>Month 70 Results<br><br>
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>{% rauserpicalt NanZyT48, NanZyT48 %}</td>
                            <td colspan=2>{% ragamepic 11133, 099334, O.D.T.: Escape... Or Die Trying %}</td>
                        </tr>
                    </tbody>
                </table>
                <br>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic NEOMAR %}<sup>**</sup> - 1591 Points</li>
                    <li value="2">{% rauserpic Lonoke31 %}<sup>**</sup> - 1508 Points</li>
                    <li value="3">{% rauserpic Sutarion %}<sup>**</sup> - 1299 Points</li>
                    <li value="4">{% rauserpic Timmay %}<sup>**</sup> - 1289 Points</li>
                    <li value="5">{% rauserpicalt AmirGaris, Amir96lx %}<sup>**</sup> - 1229 Points</li>
