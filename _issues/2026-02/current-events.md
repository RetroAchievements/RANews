...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>105 users are tied in first with 13 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>26 users are currently tied in first place with 18 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic Verros %} - 86 Points</li>
        ...
        <tr>
            ...
            <td>
                <ol>
                    ...
                    <li value="7">{% rauserpic jhonen124 %} - 12 Points</li>
                    <li value="1">{% rauserpic xeiden %} - 12 Points</li>
                    <li value="1">{% rauserpic Retrokaiser %} - 12 Points</li>
                    <li value="10">{% rauserpic SRamos %} - 11 Points</li>
                </ol>
            ...
            <td>Month 66 Results<br><br>
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td rowspan=2>{% rauserpic Erodion %}</td>
                            <td colspan=2>{% ragamepic 6809, 124577, Choplifter %}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan=2>{% ragamepic 17482, 042610, Super Collapse! 3 %}</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td rowspan=2>{% rauserpic Trisscorp %}</td>
                            <td colspan=2>{% ragamepic 16923, 121447, Zool 2 %}</td>
                        </tr>
                        <tr>
                            <td colspan=2>{% ragamepic 13996, 069467, Chack'n Pop %}</td>
                        </tr>
                        <tr>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic NEOMAR %}<sup>**</sup> - 1496 Points</li>
                    <li value="2">{% rauserpic Lonoke31 %}<sup>**</sup> - 1413 Points</li>
                    <li value="3">{% rauserpic Sutarion %}<sup>**</sup> - 1204 Points</li>
                    <li value="4">{% rauserpic Timmay %}<sup>**</sup> - 1194 Points</li>
                    <li value="5">{% rauserpicalt AmirGaris, Amir96lx %}<sup>**</sup> - 1134 Points</li>
                    <li value="6">{% rauserpic MiningMario %}<sup>**</sup> - 1102 Points</li>
                    <li value="7">{% rauserpic NeoRetroGamer %}<sup>**</sup> - 762 Points</li>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Notable Details:</strong></td>
            <td>Season 3: October 1st - December 31st</td>
        </tr>
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>
                ...
                <tr>
                    <td style="vertical-align: top;">
                        <ol>
                            <li value="1" >{% rauserpic gaytorbeans %} - 40 Points</li>
                            <li value="2" >{% rauserpic JRodslegend %} - 29 Points</li>
                            <li value="3" >{% rauserpic Minyu %} - 28 Points</li>
                            <li value="4" >{% rauserpic Knav %} - 26 Points</li>
                            <li value="5" >{% rauserpicalt TrashPaddy, PaddyShade %} - 25 Points</li>
                            <li value="5" >{% rauserpic Kaiserlucas %} - 25 Points</li>
                            <li value="7" >{% rauserpic HybridStatic %} - 23 Points</li>
                            <li value="8" >{% rauserpic Mindhral %} - 22 Points</li>
                            <li value="9" >{% rauserpic Manperson %} - 21 Points</li>
                            <li value="10" >{% rauserpic xClawz %} - 19 Points</li>
                        </ol>
                    </td>
                </tr>
                </tbody>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic WanderingHeiho %} - 168 Points</li>
                    ...
                    <li value="3">{% rauserpic TanteiRotana %} - 160 Points</li>
                    <li value="3">{% rauserpic HungryWalnut %} - 160 Points</li>
                </ol>
                <br>Check out the game page for the up to date rankings.
            </td>
        </tr>
...
## Bounty Hunters Villains

<table>
    <tbody>
        <tr>
            <td><strong>Event Page:</strong></td>
            <td>{% raeventpic 185, 117583, Bounty Hunters Villains %}</td>
        </tr>
        <tr>
            <td><strong>Event Summary:</strong></td>
            <td>Features 12 popular video game villains over 24 weeks, with participants completing tasks of varying lengths every 2 weeks to earn points towards badges.</td>
        </tr>
        <tr>
            <td><strong>Event Information:</strong></td>
            <td><a href="https://retroachievements.org/viewtopic.php?t=32219">https://retroachievements.org/viewtopic.php?t=32219</a></td>
        </tr>
        <tr>
            <td><strong>Duration:</strong></td>
            <td>Active from 9/10/25 - 3/3/26</td>
        </tr>
        <tr>
            <td><strong>Host(s):</strong></td>
            <td>{% rauserpic RAEvents %}</td>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>23 users have mastered the Bounty Hunters Villains event.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>