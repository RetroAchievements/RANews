...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>130 users are tied in first with 35 points.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
        ...
        <tr>
            ...
            <td>
                <ol>
                    ...
                    <li value="5">{% rauserpic ZTZT %} - Points 73</li>
                    <li value="5">{% rauserpic MentalBlank %} - Points 73</li>
                    <li value="10">{% rauserpic LeeD %} - Points 72</li>
                    <li value="10">{% rauserpic Eferos %} - Points 72</li>
                </ol>
...
<table>
    <tbody>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li value="1">{% rauserpic Tashemi %} - 9 Points</li>
                    ...
                    <li value="9">37 users tied in 9th with 7 Points</li>
                </ol>
                <br>Check out the game page for the up to date rankings.
            </td>
        </tr>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>5 players are tied in first with 11 gym clears and 8 players are tied in sixth with 10 gym clears.<br><br>Check out the <a href="https://docs.google.com/spreadsheets/d/1xIAZcS4rgX9kkRG2Ixk4fgFteBxubObv4EuZB57ICuU/edit?gid=0#gid=0">scoring sheet</a> for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
...
<table>
    <tbody>
        ...
        <tr>
            <td><strong>Rankings:</strong></td>
            <td>24 players have earned the DevJam Vol. 1 badge.<br><br>Check out the game page for the up to date rankings.</td>
        </tr>
    </tbody>
</table>
            ...
            <td>Month 71 Results<br><br>
                <table>
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td colspan=2>{% ragamepic 5616, 089060, Raw Danger! %}</td>
                        </tr>
                    </tbody>
                </table>
                <br>
