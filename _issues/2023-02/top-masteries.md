...
| Event Awards                | {% rauserpic Hotscrock %}                                                      | 18             | <!-- 101 --> |
...
| Arcade                      | {% rauserpic Wendigo%}                                                         | 64             | <!-- 27  --> |
...
| ColecoVision                | {% rauserpic PMniac %}                                                         | 11             | <!-- 44  --> |
| Dreamcast                   | {% rauserpic SteveHarvey %}                                                    | 19             | <!-- 40  --> |
| Fairchild Channel F         | {% rauserpic Maximdraco %}                                                     | 23             | <!-- 57  --> |
| Game Boy                    | {% rauserpic Shootzy %}                                                        | 128            | <!-- 4   --> |
| Game Boy Advance            | {% rauserpic bonecrusher1022 %}                                                | 125            | <!-- 5   --> |
| Game Boy Color              | {% rauserpic pitapocket17 %}                                                   | 95             | <!-- 6   --> |
| Game Gear                   | {% rauserpic Nydaxn %}                                                         | 72             | <!-- 15  --> |
| Hack Champ                  | {% rauserpic HolyShinx %}                                                      | 209            | <!--     --> |
| Homebrew Champ              | {% rauserpic AuburnRDM %}                                                      | 188            | <!--     --> |
| Intellivision               | {% rauserpic Jungon %}                                                         | 16             | <!-- 45  --> |
| Magnavox Odyssey 2          | {% rauserpic Jungon %}                                                         | 8              | <!-- 23  --> |
| Master System               | {% rauserpic Jungon %}                                                         | 81             | <!-- 11  --> |
...
| PC Engine                   | {% rauserpic Infernum %}                                                       | 34             | <!-- 8   --> |
| PC Engine CD                | {% rauserpic Annonith %}                                                       | 10             | <!-- 76  --> |
| PC-8000/8800                | {% rauserpic Orph %}                                                           | 14             | <!-- 47  --> |
| PC-FX                       | {% rauserpic guineu %}                                                         | 6              | <!-- 49  --> |
| PlayStation                 | {% rauserpic FBiDev %}                                                         | 89             | <!-- 12  --> |
| PlayStation 2               | {% rauserpic Infernum %}                                                       | 26             | <!-- 21  --> |
| PlayStation Portable        | {% rauserpic minibt %}                                                         | 38             | <!-- 41  --> |
| Pokémon Mini                | {% rauserpic Sylrifaide %}                                                     | 36             | <!-- 24  --> |
| Sega 32X                    | {% rauserpic DUT %} & {% rauserpic Nevanos %}                                  | 3              | <!-- 10  --> |
| Sega Saturn                 | {% rauserpic Orph %}                                                           | 16             | <!-- 39  --> |
| Sega CD                     | {% rauserpic Orph %}                                                           | 10             | <!-- 9   --> |
| SG-1000                     | {% rauserpic PMniac %} & {% rauserpic Jungon %}                                | 11             | <!-- 33  --> |
| SNES                        | {% rauserpic danibodom %}                                                      | 210            | <!-- 3   --> |
| Vectrex                     | {% rauserpic Jungon %}                                                         | 9              | <!-- 46  --> |
| Virtual Boy                 | {% rauserpic Grahamtams %}                                                     | 15             | <!-- 28  --> |
| WASM-4                      | {% rauserpic AuburnRDM %}                                                      | 31             | <!-- 72  --> |
